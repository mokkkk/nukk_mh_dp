...
# give @s clock{display:{Name:'{"text":"火竜の鱗","italic":false}',Lore:['{"text":"火竜の体を覆う鱗．","italic":false}','{"text":"武器の素材として使用される．","italic":false}']},CustomModelData:10000,MhdpID:1}

# give @s clock{display:{Name:'{"text":"竜骨","italic":false}',Lore:['{"text":"頑強な竜の骨．様々な用途がある．","italic":false}']},CustomModelData:10018,MhdpID:19}
