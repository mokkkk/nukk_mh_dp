...
# バージョン設定
execute if score #mhdp_bersion AsaMatrix matches ..1 run function mh_dp:settings/setup/beta41
execute if score #mhdp_bersion AsaMatrix matches ..2 run function mh_dp:settings/setup/beta42
