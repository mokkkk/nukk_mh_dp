# ダメージ軽減
    ...
    data modify storage mhdp: Armor append from entity @s Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
    data modify storage mhdp: Armor append from entity @s Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
    data modify storage mhdp: Armor append from entity @s Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
    data modify storage mhdp: Armor append from entity @s Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
# 明示的に0に設定
