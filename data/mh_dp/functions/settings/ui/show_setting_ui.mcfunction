...
tellraw @a {"text": "==========================================\n\nMH_DP Settings","color": "light_purple"}

execute if data storage mh_dp:status Flag{QuestRank:true} run tellraw @a {"text": "\n - クエストランク","color": "light_purple"}
execute if data storage mh_dp:status Flag{QuestRank:true} if data storage mh_dp:settings Custom{QuestRank:0} run tellraw @a [{"text": " ---  ","color": "light_purple"},{"text": "[ノーマル]       ","color": "aqua","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/questrank/normal"}},{"text": "[ハード]","color": "light_purple","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/questrank/hard"}}]
execute if data storage mh_dp:status Flag{QuestRank:true} if data storage mh_dp:settings Custom{QuestRank:1} run tellraw @a [{"text": " ---  ","color": "light_purple"},{"text": "[ノーマル]       ","color": "light_purple","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/questrank/normal"}},{"text": "[ハード]","color": "aqua","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/questrank/hard"}}]
...
tellraw @a {"text": "\n - モンスターのデスポーン","color": "light_purple"}
execute if data storage mh_dp:settings Custom{DisableDespawn:false} run tellraw @a [{"text": " ---  ","color": "light_purple"},{"text": "[有効]       ","color": "aqua","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/despawn/disable"}},{"text": "[無効]","color": "light_purple","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/despawn/enable"}}]
execute if data storage mh_dp:settings Custom{DisableDespawn:true} run tellraw @a [{"text": " ---  ","color": "light_purple"},{"text": "[有効]       ","color": "light_purple","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/despawn/disable"}},{"text": "[無効]","color": "aqua","clickEvent":{"action":"run_command","value":"/function mh_dp:settings/despawn/enable"}}]
