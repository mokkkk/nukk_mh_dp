data modify storage asa_matrix: Rotate set value [0f,0f,-750f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-500f,0f,-750f]
