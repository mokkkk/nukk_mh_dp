data modify storage asa_matrix: Rotate set value [-2800f,0f,500f]
...
data modify storage asa_matrix: Rotate set value [-3800f,0f,500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3300f,0f,500f]
...
data modify storage asa_matrix: Rotate set value [2200f,0f,500f]
