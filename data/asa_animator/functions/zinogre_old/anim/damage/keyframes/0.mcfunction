data modify storage asa_matrix: Rotate set value [-250f,0f,25000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [3500f,0f,25000f]
...
data modify storage asa_matrix: Rotate set value [1625f,0f,25000f]
