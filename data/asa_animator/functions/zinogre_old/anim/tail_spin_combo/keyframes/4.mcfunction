...
data modify storage asa_matrix: Rotate set value [5000f,6000f,18000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1000f,6000f,18000f]
...
data modify storage asa_matrix: Rotate set value [-3000f,6000f,18000f]
