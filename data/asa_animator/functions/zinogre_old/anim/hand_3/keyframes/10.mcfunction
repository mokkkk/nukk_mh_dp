...
data modify storage asa_matrix: Rotate set value [12000f,-12000f,2000f]
...
data modify storage asa_matrix: Rotate set value [6000f,-12000f,2000f]
...
data modify storage asa_matrix: Rotate set value [20000f,-12000f,2000f]
...
data modify storage asa_matrix: Rotate set value [0f,-20000f,7000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-10400f,-2000f,7000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2400f,-20000f,7000f]
