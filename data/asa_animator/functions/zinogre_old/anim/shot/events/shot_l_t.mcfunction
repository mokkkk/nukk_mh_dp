...
summon marker ~ ~ ~ {Tags:["MonsterShot","ZinogreThunder","C","L","Start"]}

execute as @e[type=marker,tag=ZinogreThunder,tag=A,tag=Start] run tp @s ~ ~0.4 ~ ~50 ~
execute as @e[type=marker,tag=ZinogreThunder,tag=B,tag=Start] run tp @s ~ ~0.4 ~ ~20 ~
execute as @e[type=marker,tag=ZinogreThunder,tag=C,tag=Start] run tp @s ~ ~0.4 ~ ~-10 ~
