...
data modify storage asa_matrix: Rotate set value [-20000f,6000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-24000f,6000f,0f]
