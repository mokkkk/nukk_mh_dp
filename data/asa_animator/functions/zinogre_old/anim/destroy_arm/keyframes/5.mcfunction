data modify storage asa_matrix: Rotate set value [-267f,-2000f,-1334f]
...
data modify storage asa_matrix: Rotate set value [-1600f,-1334f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1600f,-667f,0f]
...
data modify storage asa_matrix: Rotate set value [-267f,333f,0f]
...
data modify storage asa_matrix: Rotate set value [-67f,333f,0f]
...
data modify storage asa_matrix: Rotate set value [400f,1333f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [200f,-1334f,-334f]
