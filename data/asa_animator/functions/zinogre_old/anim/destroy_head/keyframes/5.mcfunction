data modify storage asa_matrix: Rotate set value [2666f,0f,-667f]
...
data modify storage asa_matrix: Rotate set value [-1334f,-1334f,-667f]
...
data modify storage asa_matrix: Rotate set value [-2667f,-3334f,-667f]
