data modify storage asa_matrix: Rotate set value [4000f,33100f,-2000f]
...
data modify storage asa_matrix: Rotate set value [6000f,22600f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-800f,33600f,0f]
