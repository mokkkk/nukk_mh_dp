...
data modify storage asa_matrix: Rotate set value [1500f,5000f,1500f]
...
data modify storage asa_matrix: Rotate set value [-2300f,5000f,-2500f]
...
data modify storage asa_matrix: Rotate set value [2700f,4000f,0f]
