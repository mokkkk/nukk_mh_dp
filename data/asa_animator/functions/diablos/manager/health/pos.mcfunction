...
execute if entity @s[tag=Body0] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=Body0,limit=1] run tp @s ^ ^0.6 ^0.2 ~ ~
execute if entity @s[tag=Body1] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=Body1,limit=1] run tp @s ^ ^0.5 ^ ~ ~
...
execute if entity @s[tag=LegL1] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=LegL1,limit=1] run tp @s ^ ^0.5 ^ ~ ~
execute if entity @s[tag=LegR1] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=LegR1,limit=1] run tp @s ^ ^0.5 ^ ~ ~
execute if entity @s[tag=Tail0] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=Tail0,limit=1] run tp @s ^ ^0.7 ^-0.2 ~ ~
execute if entity @s[tag=Tail1] rotated as @s at @e[type=armor_stand,tag=DiablosParts,tag=Tail1,limit=1] run tp @s ^ ^0.7 ^0.4 ~ ~
...
# HP確認
execute if entity @s[nbt=!{Health:1000f}] run function asa_animator:diablos/health/check