...
tag @s remove AnmTailShot
tag @s remove AnmShortDash
tag @s remove AnmWalkL
tag @s remove AnmWalkR
tag @s remove AnmShortDashC
tag @s remove AnmMove
tag @s remove AnmDashStart
tag @s remove AnmDash
tag @s remove AnmDashTurnL
tag @s remove AnmDashTurnR
tag @s remove AnmDashAttack
