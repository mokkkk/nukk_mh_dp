...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/dash_turn_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/dash_turn_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^-0.02 ^-0.04 ^-0.04
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:diablos/anim/dash_turn_l/keyframes/1
execute if entity @s[scores={AsaMatrix=6..15}] run tp @s ^-0.01 ^0 ^-0.13
execute if entity @s[scores={AsaMatrix=16}] run function asa_animator:diablos/anim/dash_turn_l/keyframes/2
execute if entity @s[scores={AsaMatrix=16..20}] run tp @s ^0.02 ^0.02 ^0.14
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:diablos/anim/dash_turn_l/keyframes/3
execute if entity @s[scores={AsaMatrix=21..25}] run tp @s ^0.02 ^0.02 ^0.16
execute if entity @s[scores={AsaMatrix=26..}] run function asa_animator:diablos/anim/dash_turn_l/end
