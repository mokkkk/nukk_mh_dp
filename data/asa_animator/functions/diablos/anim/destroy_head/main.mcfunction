...
execute if entity @s[scores={AsaMatrix=1..6}] run tp @s ^0 ^0 ^0.008333334 ~0.5 ~
execute if entity @s[scores={AsaMatrix=7}] run function asa_animator:diablos/anim/destroy_head/keyframes/1
execute if entity @s[scores={AsaMatrix=7..12}] run tp @s ^0 ^-0.03333334 ^0.008333334
...
execute if entity @s[scores={AsaMatrix=16..23}] run tp @s ^0 ^0 ^0
...
execute if entity @s[scores={AsaMatrix=32..42}] run tp @s ^0 ^-0.02727273 ^0
execute if entity @s[scores={AsaMatrix=43}] run function asa_animator:diablos/anim/destroy_head/keyframes/6
execute if entity @s[scores={AsaMatrix=43..47}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=48}] run function asa_animator:diablos/anim/destroy_head/keyframes/7
execute if entity @s[scores={AsaMatrix=48..60}] run tp @s ^0 ^0.03846154 ^-0.007692308
execute if entity @s[scores={AsaMatrix=61..}] run function asa_animator:diablos/anim/destroy_head/end
