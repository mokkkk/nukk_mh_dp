...
execute if score @s AsaMatrix matches 41 unless entity @s[tag=DestroyHead] as @e[type=armor_stand,tag=DiablosParts,tag=HeadU,] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10039
execute if score @s AsaMatrix matches 41 if entity @s[tag=DestroyHead] as @e[type=armor_stand,tag=DiablosParts,tag=HeadU] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10295