...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/normal/dash/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/normal/dash/keyframes/0
execute if entity @s[scores={AsaMatrix=1..4}] run tp @s ^0 ^0.075 ^1.25
execute if entity @s[scores={AsaMatrix=5}] run function asa_animator:diablos/anim/normal/dash/keyframes/1
execute if entity @s[scores={AsaMatrix=5..8}] run tp @s ^0 ^-0.075 ^1.25
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:diablos/anim/normal/dash/keyframes/2
execute if entity @s[scores={AsaMatrix=9..12}] run tp @s ^0 ^0.075 ^1.25
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:diablos/anim/normal/dash/keyframes/3
execute if entity @s[scores={AsaMatrix=13..16}] run tp @s ^0 ^-0.075 ^1.25
execute if entity @s[scores={AsaMatrix=17..}] run function asa_animator:diablos/anim/normal/dash/end
