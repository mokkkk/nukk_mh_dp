...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/move/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/move/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0.06 ^0.8
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:diablos/anim/move/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^-0.06 ^0.8
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:diablos/anim/move/keyframes/2
execute if entity @s[scores={AsaMatrix=11..15}] run tp @s ^0 ^0.06 ^0.8
execute if entity @s[scores={AsaMatrix=16}] run function asa_animator:diablos/anim/move/keyframes/3
execute if entity @s[scores={AsaMatrix=16..20}] run tp @s ^0 ^-0.06 ^0.8
execute if entity @s[scores={AsaMatrix=21..}] run function asa_animator:diablos/anim/move/end
...
# 敵に十分近づいた場合，遷移
execute positioned ^ ^ ^6 if entity @e[tag=DiablosAttackTarget,distance=0..4] run function asa_animator:diablos/anim/move/events/change
