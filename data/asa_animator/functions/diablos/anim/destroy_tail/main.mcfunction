...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/destroy_tail/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:diablos/anim/destroy_tail/keyframes/0
execute if entity @s[scores={AsaMatrix=1..6}] run tp @s ^0 ^0.05 ^0.6666667 ~3 ~
execute if entity @s[scores={AsaMatrix=7}] run function asa_animator:diablos/anim/destroy_tail/keyframes/1
...
execute if entity @s[scores={AsaMatrix=56}] run function asa_animator:diablos/anim/destroy_tail/keyframes/6
execute if entity @s[scores={AsaMatrix=56..65}] run tp @s ^0 ^0.02 ^0 ~-0.1 ~
execute if entity @s[scores={AsaMatrix=66..}] run function asa_animator:diablos/anim/destroy_tail/end
