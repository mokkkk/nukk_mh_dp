...
execute if entity @s[scores={AsaMatrix=16..65}] run playsound entity.zombie_horse.death master @a ~ ~ ~ 3 1.1 0.05
...
execute if entity @s[scores={AsaMatrix=46..65}] run playsound entity.zombie_horse.death master @a ~ ~ ~ 3 0.9 0.05
