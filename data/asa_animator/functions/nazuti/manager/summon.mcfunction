...
# パーツ召喚
execute if data storage mhdp: {ExistMonster:0b} positioned ^ ^30 ^6 run function asa_animator:nazuti/summon

# 当たり判定召喚
execute if data storage mhdp: {ExistMonster:0b} positioned ^ ^30 ^6 run function asa_animator:nazuti/manager/health/summon
