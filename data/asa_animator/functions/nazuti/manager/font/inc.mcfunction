...
scoreboard players add #mhdp_nazuti_font AsaMatrix 1
execute if score #mhdp_nazuti_font AsaMatrix matches ..6 run schedule function asa_animator:nazuti/manager/font/inc 1t replace
execute if score #mhdp_nazuti_font AsaMatrix matches 7.. run tag @e[tag=NazutiRoot] remove MhdpInc
