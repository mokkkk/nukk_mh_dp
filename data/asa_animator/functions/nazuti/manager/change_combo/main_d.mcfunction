...
execute if score #mhdp_nazuti_combo_count AsaMatrix matches 2.. run function asa_animator:nazuti/manager/change_normal/_/head
execute if score #mhdp_nazuti_combo_count AsaMatrix matches 2.. run tag @s remove ComboD