...
execute if entity @s[tag=DestroyBody,tag=!IsInvisible] run data modify entity @e[type=armor_stand,tag=NazutiParts,tag=WingL0,limit=1] ArmorItems[3].tag.CustomModelData set value 10423
execute if entity @s[tag=DestroyBody,tag=!IsInvisible] run data modify entity @e[type=armor_stand,tag=NazutiParts,tag=WingR0,limit=1] ArmorItems[3].tag.CustomModelData set value 10423
execute if entity @s[tag=DestroyBody,tag=!IsInvisible] run data modify entity @e[type=armor_stand,tag=NazutiParts,tag=WingL1,limit=1] ArmorItems[3].tag.CustomModelData set value 10424
execute if entity @s[tag=DestroyBody,tag=!IsInvisible] run data modify entity @e[type=armor_stand,tag=NazutiParts,tag=WingR1,limit=1] ArmorItems[3].tag.CustomModelData set value 10424
