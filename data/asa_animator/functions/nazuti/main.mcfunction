...
# execute if predicate asa_animator:nazuti/stay if entity @s[tag=!IsStand] run function asa_animator:nazuti/anim/stay/main
# execute if predicate asa_animator:nazuti/stay if entity @s[tag=IsFlying,tag=!IsStand] run function asa_animator:nazuti/anim/flying_stay/main
# 軸合わせ
