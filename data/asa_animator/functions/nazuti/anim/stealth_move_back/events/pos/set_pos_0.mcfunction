...
# 地上にmarkerセット
summon marker ^ ^ ^12 {Tags:["NazutiMovePos"]}
execute facing entity @e[tag=NazutiAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=NazutiAttackTarget] positioned as @s run tp @e[type=marker,tag=NazutiMovePos] ^ ^ ^10
