...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:nazuti/anim/head_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:nazuti/anim/head_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..7}] run tp @s ^0 ^0.01428571 ^0
execute if entity @s[scores={AsaMatrix=8}] run function asa_animator:nazuti/anim/head_l/keyframes/1
execute if entity @s[scores={AsaMatrix=8..14}] run tp @s ^0 ^-0.01428571 ^0 ~-10 ~
execute if entity @s[scores={AsaMatrix=15}] run function asa_animator:nazuti/anim/head_l/keyframes/2
execute if entity @s[scores={AsaMatrix=15..25}] run tp @s ^0 ^0 ^0 ~-2 ~
execute if entity @s[scores={AsaMatrix=26}] run function asa_animator:nazuti/anim/head_l/keyframes/3
execute if entity @s[scores={AsaMatrix=26..37}] run tp @s ^0 ^0 ^0.1 ~6 ~
execute if entity @s[scores={AsaMatrix=38}] run function asa_animator:nazuti/anim/head_l/keyframes/4
execute if entity @s[scores={AsaMatrix=38..45}] run tp @s ^0 ^0 ^0.3 ~6 ~
execute if entity @s[scores={AsaMatrix=46}] run function asa_animator:nazuti/anim/head_l/keyframes/5
execute if entity @s[scores={AsaMatrix=46..55}] run tp @s ^0 ^0.01 ^0.1 ~3 ~
execute if entity @s[scores={AsaMatrix=56}] run function asa_animator:nazuti/anim/head_l/keyframes/6
execute if entity @s[scores={AsaMatrix=56..65}] run tp @s ^0 ^-0.01 ^0 ~3 ~
execute if entity @s[scores={AsaMatrix=66}] run function asa_animator:nazuti/anim/head_l/keyframes/7
execute if entity @s[scores={AsaMatrix=66..70}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=71}] run function asa_animator:nazuti/anim/head_l/keyframes/8
execute if entity @s[scores={AsaMatrix=71..85}] run tp @s ^0 ^0 ^0 ~-1 ~
execute if entity @s[scores={AsaMatrix=86..}] run function asa_animator:nazuti/anim/head_l/end
