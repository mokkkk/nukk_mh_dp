...
execute if entity @s[scores={AsaMatrix=45..55}] run tp @s ^0 ^0.009090909 ^0
execute if entity @s[scores={AsaMatrix=56..}] run function asa_animator:nazuti/anim/voice/end
execute as @e[type=armor_stand,tag=NazutiParts] run function #asa_matrix:animate
function asa_animator:nazuti/model

execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:nazuti/manager/change_target
...
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:nazuti/manager/model/stealth_end