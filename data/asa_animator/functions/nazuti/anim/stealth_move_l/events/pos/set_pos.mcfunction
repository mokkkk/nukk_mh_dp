...
# 地上にmarkerセット
summon marker ^7 ^ ^7 {Tags:["NazutiMovePos"]}
execute facing entity @e[tag=NazutiAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=NazutiAttackTarget] positioned as @s run tp @e[type=marker,tag=NazutiMovePos] ^10 ^ ^5
...
execute as @e[type=marker,tag=NazutiMovePos,limit=1] at @s run tp @s ~ ~0.12 ~
...
scoreboard players set #nazuti_height_target AsaMatrix 23
scoreboard players operation #nazuti_mine_x AsaMatrix /= #nazuti_height_target AsaMatrix
scoreboard players operation #nazuti_mine_y AsaMatrix /= #nazuti_height_target AsaMatrix
scoreboard players operation #nazuti_mine_z AsaMatrix /= #nazuti_height_target AsaMatrix
