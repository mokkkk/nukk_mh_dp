...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:nazuti/anim/stealth_move_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..6}] run tp @s ^0 ^-0.01666667 ^0
execute if entity @s[scores={AsaMatrix=7}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/1
execute if entity @s[scores={AsaMatrix=7..12}] run tp @s ^0 ^0.5833334 ^0
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/2
execute if entity @s[scores={AsaMatrix=13..20}] run tp @s ^0 ^-0.125 ^0
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/3
execute if entity @s[scores={AsaMatrix=21..28}] run tp @s ^0 ^-0.3 ^0
execute if entity @s[scores={AsaMatrix=29}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/4
execute if entity @s[scores={AsaMatrix=29..32}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=33}] run function asa_animator:nazuti/anim/stealth_move_l/keyframes/5
execute if entity @s[scores={AsaMatrix=33..42}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=43..}] run function asa_animator:nazuti/anim/stealth_move_l/end
...
execute if entity @s[scores={AsaMatrix=5}] run function asa_animator:nazuti/anim/stealth_move_l/events/pos/set_pos
