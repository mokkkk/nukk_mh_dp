...
execute if entity @s[scores={AsaMatrix=..0}] run particle spit ~ ~ ~ 0 0 0 0.2 3
execute if entity @s[scores={AsaMatrix=1..}] positioned ^ ^ ^1 run function asa_animator:nazuti/anim/tongue_l/events/tongue
