...
execute if entity @s[scores={AsaMatrix=32..37}] run tp @s ^0 ^-0.1333333 ^0
execute if entity @s[scores={AsaMatrix=38}] run function asa_animator:nazuti/anim/jump/keyframes/5
execute if entity @s[scores={AsaMatrix=38..43}] run tp @s ^0 ^-0.5333334 ^0
execute if entity @s[scores={AsaMatrix=44}] run function asa_animator:nazuti/anim/jump/keyframes/6
execute if entity @s[scores={AsaMatrix=44..53}] run tp @s ^0 ^0 ^0.1
execute if entity @s[scores={AsaMatrix=54..60}] run tp @s ^0 ^0 ^0
...
execute if entity @s[scores={AsaMatrix=..19}] at @s run function asa_animator:nazuti/manager/rotate
execute if entity @s[scores={AsaMatrix=25}] at @s run function asa_animator:nazuti/anim/jump/events/pos/set_pos
execute if entity @s[scores={AsaMatrix=26..43}] at @s run function asa_animator:nazuti/anim/jump/events/pos/offset
execute if entity @s[scores={AsaMatrix=36..43}] at @s run function asa_animator:nazuti/anim/jump/events/damage
