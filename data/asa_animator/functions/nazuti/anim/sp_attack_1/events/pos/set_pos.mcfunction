...
# 地上にmarkerセット
summon marker ^ ^ ^7 {Tags:["NazutiMovePos"]}
execute facing entity @e[tag=NazutiAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=NazutiAttackTarget] positioned as @s run tp @e[type=marker,tag=NazutiMovePos] ^ ^ ^4
...
scoreboard players set #nazuti_height_target AsaMatrix 44
scoreboard players operation #nazuti_mine_x AsaMatrix /= #nazuti_height_target AsaMatrix
scoreboard players operation #nazuti_mine_y AsaMatrix /= #nazuti_height_target AsaMatrix
scoreboard players operation #nazuti_mine_z AsaMatrix /= #nazuti_height_target AsaMatrix
