...
execute if score #mhdp_nazuti_temp AsaMatrix matches 6..7 run particle dust 0.643 0.322 0.706 3 ^ ^ ^ 1 1 1 0.05 5
execute if score #mhdp_nazuti_temp AsaMatrix matches 8 run particle dust 0.643 0.322 0.706 3 ^ ^ ^ 1.2 1.2 1.2 0.05 5
execute if score #mhdp_nazuti_temp AsaMatrix matches 9.. run particle dust 0.643 0.322 0.706 3 ^ ^ ^ 1.5 1.5 1.5 0.05 7
