...
# 地上にmarkerセット
summon marker ^ ^10 ^15 {Tags:["MagaraMovePos"]}
execute facing entity @e[tag=MagaraAttackTarget,limit=1] feet rotated ~ 0 run tp @e[type=marker,tag=MagaraMovePos,limit=1] ^ ^ ^15
