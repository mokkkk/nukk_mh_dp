...
execute rotated ~ 0 as @e[type=marker,tag=MagaraMoveRotate] positioned as @e[tag=MagaraAttackTarget] run tp @e[type=marker,tag=MagaraMovePos] ^ ^5 ^15
execute as @e[type=marker,tag=MagaraMovePos,limit=1] at @s align y positioned ~ ~5 ~ run function asa_animator:magara/manager/check_ground
execute as @e[type=marker,tag=MagaraMovePos,limit=1] at @s run tp @s ~ ~0.1 ~
...
scoreboard players set #magara_height_target AsaMatrix 22
scoreboard players operation #magara_mine_x AsaMatrix /= #magara_height_target AsaMatrix
scoreboard players operation #magara_mine_y AsaMatrix /= #magara_height_target AsaMatrix
scoreboard players operation #magara_mine_z AsaMatrix /= #magara_height_target AsaMatrix
