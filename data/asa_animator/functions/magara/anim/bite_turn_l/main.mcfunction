...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:magara/anim/bite_turn_l/start
...
execute if entity @s[scores={AsaMatrix=45}] run function asa_animator:magara/anim/bite_turn_l/keyframes/6
execute if entity @s[scores={AsaMatrix=45..49}] run tp @s ^-0.1 ^-0.28 ^-0.3 ~-12 ~
execute if entity @s[scores={AsaMatrix=50}] run function asa_animator:magara/anim/bite_turn_l/keyframes/7
execute if entity @s[scores={AsaMatrix=50..55}] run tp @s ^0 ^-0.01666667 ^0 ~-1 ~
execute if entity @s[scores={AsaMatrix=56}] run function asa_animator:magara/anim/bite_turn_l/keyframes/8
execute if entity @s[scores={AsaMatrix=56..65}] run tp @s ^0 ^0 ^0 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=66}] run function asa_animator:magara/anim/bite_turn_l/keyframes/9
execute if entity @s[scores={AsaMatrix=66..80}] run tp @s ^0 ^-0.006666667 ^0 ~1 ~
execute if entity @s[scores={AsaMatrix=81..}] run function asa_animator:magara/anim/bite_turn_l/end
