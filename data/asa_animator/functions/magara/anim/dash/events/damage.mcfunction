...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!MagaraParts,distance=..4.6] run function asa_animator:magara/anim/dash/events/damage_sub
