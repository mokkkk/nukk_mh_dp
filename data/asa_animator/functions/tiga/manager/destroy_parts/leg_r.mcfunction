...
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR1,limit=1] at @s run particle block bone_block ~ ~1.4 ~ 0.2 0.2 0.2 0 10
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR1,limit=1] at @s run loot spawn ~ ~ ~ loot mh_dp:bonus/dyno_parts
