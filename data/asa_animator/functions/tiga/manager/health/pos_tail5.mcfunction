...
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail4,limit=1] at @s run function #asa_matrix:get_parent_pos
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail4,limit=1] run function #asa_matrix:matrix_node
