...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!TigaParts,distance=0..3.5] run function asa_animator:tiga/anim/shot_l/events/shot/damage_sub
