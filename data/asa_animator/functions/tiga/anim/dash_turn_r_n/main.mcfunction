...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:tiga/anim/dash_turn_r_n/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^-0.02 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/1
execute if entity @s[scores={AsaMatrix=6..13}] run tp @s ^0 ^0 ^-0.125
execute if entity @s[scores={AsaMatrix=14}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/2
execute if entity @s[scores={AsaMatrix=14..23}] run tp @s ^0 ^0 ^-0.05
execute if entity @s[scores={AsaMatrix=24}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/3
execute if entity @s[scores={AsaMatrix=24..27}] run tp @s ^0 ^0.01666667 ^0.125
execute if entity @s[scores={AsaMatrix=28}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/4
execute if entity @s[scores={AsaMatrix=28..31}] run tp @s ^0 ^0.01666667 ^0.125
execute if entity @s[scores={AsaMatrix=32}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/5
execute if entity @s[scores={AsaMatrix=32..35}] run tp @s ^0 ^0.01666667 ^0.125
execute if entity @s[scores={AsaMatrix=36}] run function asa_animator:tiga/anim/dash_turn_r_n/keyframes/6
execute if entity @s[scores={AsaMatrix=36..39}] run tp @s ^0 ^-0.025 ^0
execute if entity @s[scores={AsaMatrix=40..}] run function asa_animator:tiga/anim/dash_turn_r_n/end
