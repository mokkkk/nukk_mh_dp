...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:tiga/anim_anger/jump/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:tiga/anim_anger/jump/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^-0.04
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:tiga/anim_anger/jump/keyframes/1
execute if entity @s[scores={AsaMatrix=6..12}] run tp @s ^0 ^0 ^-0.01428572
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:tiga/anim_anger/jump/keyframes/2
execute if entity @s[scores={AsaMatrix=13..16}] run tp @s ^0 ^1.25 ^0
execute if entity @s[scores={AsaMatrix=17}] run function asa_animator:tiga/anim_anger/jump/keyframes/3
execute if entity @s[scores={AsaMatrix=17..20}] run tp @s ^0 ^0.75 ^0
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:tiga/anim_anger/jump/keyframes/4
execute if entity @s[scores={AsaMatrix=21..24}] run tp @s ^0 ^-0.825 ^0
execute if entity @s[scores={AsaMatrix=25}] run function asa_animator:tiga/anim_anger/jump/keyframes/5
execute if entity @s[scores={AsaMatrix=25..29}] run tp @s ^0 ^-1.06 ^0
execute if entity @s[scores={AsaMatrix=30}] run function asa_animator:tiga/anim_anger/jump/keyframes/6
execute if entity @s[scores={AsaMatrix=30..35}] run tp @s ^0 ^0 ^0.7 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=36}] run function asa_animator:tiga/anim_anger/jump/keyframes/7
execute if entity @s[scores={AsaMatrix=36..43}] run tp @s ^0 ^0 ^0.3
execute if entity @s[scores={AsaMatrix=44}] run function asa_animator:tiga/anim_anger/jump/keyframes/8
execute if entity @s[scores={AsaMatrix=44..51}] run tp @s ^0 ^0.075 ^0.1
execute if entity @s[scores={AsaMatrix=52..}] run function asa_animator:tiga/anim/jump/end
...
execute if entity @s[scores={AsaMatrix=29..34}] run playsound block.grass.step master @a ~ ~ ~ 2 0.5
execute if entity @s[scores={AsaMatrix=15..34}] run function asa_animator:tiga/anim/jump/events/damage
