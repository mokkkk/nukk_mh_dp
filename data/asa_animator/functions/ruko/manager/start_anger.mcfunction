...
# ボスバー設定
    ...
    execute if entity @s[tag=IsAnger] run execute if score #mhdp_ruko_lv AsaMatrix matches 2.. run bossbar set asa_animator:ruko_health name [{"score":{"name":"#mhdp_ruko_font","objective":"AsaMatrix"},"font": "mhdp_teo"},{"text": "\uF80E","font": "default"},{"text": "極龍","font": "default"},{"text":"\uE001","font":"mhdp"},{"text": "\uF82E","font": "default"}]