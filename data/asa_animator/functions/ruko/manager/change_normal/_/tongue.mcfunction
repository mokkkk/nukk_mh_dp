...
execute if entity @s[tag=NoRotate] run tag @s add AnmTongueC
execute if entity @s[tag=Right,tag=!NoRotate] run tag @s add AnmTongueR
execute if entity @s[tag=!NoRotate,tag=!Right] run tag @s add AnmTongueL
