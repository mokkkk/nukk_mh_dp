...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/claw_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/claw_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^-0.02 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:ruko/anim/claw_l/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^0.06 ^0
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:ruko/anim/claw_l/keyframes/2
execute if entity @s[scores={AsaMatrix=11..17}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=18}] run function asa_animator:ruko/anim/claw_l/keyframes/3
execute if entity @s[scores={AsaMatrix=18..20}] run tp @s ^0 ^-0.03333334 ^0.03333334 ~-1 ~
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:ruko/anim/claw_l/keyframes/4
execute if entity @s[scores={AsaMatrix=21..24}] run tp @s ^0 ^-0.025 ^0.025 ~-1 ~
execute if entity @s[scores={AsaMatrix=25}] run function asa_animator:ruko/anim/claw_l/keyframes/5
execute if entity @s[scores={AsaMatrix=25..32}] run tp @s ^0 ^-0.0125 ^0 ~-1 ~
execute if entity @s[scores={AsaMatrix=33}] run function asa_animator:ruko/anim/claw_l/keyframes/6
execute if entity @s[scores={AsaMatrix=33..45}] run tp @s ^0 ^0.007692308 ^-0.01538462 ~0.5 ~
execute if entity @s[scores={AsaMatrix=46..}] run function asa_animator:ruko/anim/claw_l/end
...
execute if entity @s[scores={AsaMatrix=32}] run function asa_animator:ruko/anim/claw_l/events/change
...
execute if entity @s[scores={AsaMatrix=1..15}] if score #mhdp_ruko_lv AsaMatrix matches 1.. run function asa_animator:ruko/manager/particle/pull
