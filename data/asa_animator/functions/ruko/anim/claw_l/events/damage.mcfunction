...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!RukoParts,distance=..3] run function asa_animator:ruko/anim/claw_l/events/damage_sub
