...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!KushalaParts,distance=0..4] run function asa_animator:ruko/anim/bjb_land/events/damage_sub
