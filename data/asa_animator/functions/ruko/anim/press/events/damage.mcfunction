...
execute as @a[distance=..5.5] run function mh_dp:player/knockback/start_dwind
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!RukoParts,distance=..5.5] run function asa_animator:ruko/anim/press/events/damage_sub
