...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!RukoParts,distance=..3.5] run function asa_animator:ruko/anim/dash/events/damage_sub
