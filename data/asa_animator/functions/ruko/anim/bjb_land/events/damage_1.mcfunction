...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!RukoParts,distance=0..6] run function asa_animator:ruko/anim/bjb_land/events/damage_sub
