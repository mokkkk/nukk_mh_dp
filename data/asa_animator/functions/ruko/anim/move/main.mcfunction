...
execute if entity @s[scores={AsaMatrix=19..}] run function asa_animator:ruko/anim/move/end
...
# 停止
execute if entity @e[tag=RukoAttackTarget,distance=0..8] run function asa_animator:ruko/anim/move/events/change