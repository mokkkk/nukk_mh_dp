...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/bite_2_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/bite_2_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:ruko/anim/bite_2_l/keyframes/1
execute if entity @s[scores={AsaMatrix=6..13}] run tp @s ^0 ^-0.0125 ^0.025 ~8 ~
execute if entity @s[scores={AsaMatrix=14}] run function asa_animator:ruko/anim/bite_2_l/keyframes/2
execute if entity @s[scores={AsaMatrix=14..23}] run tp @s ^0 ^0 ^0 ~1 ~
execute if entity @s[scores={AsaMatrix=24}] run function asa_animator:ruko/anim/bite_2_l/keyframes/3
execute if entity @s[scores={AsaMatrix=24..31}] run tp @s ^-0.0125 ^0.0375 ^-0.025
execute if entity @s[scores={AsaMatrix=32}] run function asa_animator:ruko/anim/bite_2_l/keyframes/4
execute if entity @s[scores={AsaMatrix=32..37}] run tp @s ^0.01666667 ^0.01666667 ^0
execute if entity @s[scores={AsaMatrix=38}] run function asa_animator:ruko/anim/bite_2_l/keyframes/5
execute if entity @s[scores={AsaMatrix=38..47}] run tp @s ^0.01 ^-0.01 ^0
execute if entity @s[scores={AsaMatrix=48}] run function asa_animator:ruko/anim/bite_2_l/keyframes/6
execute if entity @s[scores={AsaMatrix=48..53}] run tp @s ^-0.01666667 ^0.01666667 ^0
execute if entity @s[scores={AsaMatrix=54}] run function asa_animator:ruko/anim/bite_2_l/keyframes/7
execute if entity @s[scores={AsaMatrix=54..63}] run tp @s ^0 ^-0.03 ^0
execute if entity @s[scores={AsaMatrix=64}] run function asa_animator:ruko/anim/bite_2_l/keyframes/8
execute if entity @s[scores={AsaMatrix=64..78}] run tp @s ^0 ^0 ^0 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=79..}] run function asa_animator:ruko/anim/bite_2_l/end
