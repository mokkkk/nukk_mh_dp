...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/bite_charge_r/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/0
execute if entity @s[scores={AsaMatrix=1..7}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=8}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/1
execute if entity @s[scores={AsaMatrix=8..12}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/2
execute if entity @s[scores={AsaMatrix=13..20}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/3
execute if entity @s[scores={AsaMatrix=21..25}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=26}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/4
execute if entity @s[scores={AsaMatrix=26..28}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=29}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/5
execute if entity @s[scores={AsaMatrix=29..38}] run tp @s ^0 ^0 ^0 ~18 ~
execute if entity @s[scores={AsaMatrix=39}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/6
execute if entity @s[scores={AsaMatrix=39..43}] run tp @s ^0 ^0 ^0 ~1 ~
execute if entity @s[scores={AsaMatrix=44}] run function asa_animator:ruko/anim/bite_charge_r/keyframes/7
execute if entity @s[scores={AsaMatrix=44..58}] run tp @s ^0 ^0 ^0 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=59..}] run function asa_animator:ruko/anim/bite_charge_r/end
...
execute if entity @s[scores={AsaMatrix=27}] run playsound entity.lightning_bolt.thunder master @a ~ ~ ~ 3 1
execute if entity @s[scores={AsaMatrix=28..40}] as @e[type=marker,tag=RukoMoveRotate,distance=0..3] at @s run tp @s ~ ~ ~ ~18 ~
execute if entity @s[scores={AsaMatrix=28..40}] at @e[type=marker,tag=RukoMoveRotate,distance=0..3] run function asa_animator:ruko/anim/bite_charge_r/events/damage
