...
execute unless entity @s[tag=DestroyHead] as @e[distance=0..30,type=armor_stand,tag=DynoParts,tag=HeadL] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10182
