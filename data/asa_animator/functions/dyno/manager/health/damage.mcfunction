...
execute if score #mhdp_dyno_legl_damage AsaMatrix matches ..0 as @e[distance=0..15,type=armor_stand,tag=DynoRoot] unless entity @s[tag=DestroyLegL] run function asa_animator:dyno/manager/destroy_parts/leg_l
execute if score #mhdp_dyno_legr_damage AsaMatrix matches ..0 as @e[distance=0..15,type=armor_stand,tag=DynoRoot] unless entity @s[tag=DestroyLegR] run function asa_animator:dyno/manager/destroy_parts/leg_r
...
execute if score #mhdp_dyno_head_heat_damage AsaMatrix matches ..-10000 as @e[distance=0..15,type=armor_stand,tag=DynoRoot] run function asa_animator:dyno/manager/destroy_parts/head_heat
