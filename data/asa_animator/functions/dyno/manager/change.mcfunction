...
# 尻尾煤化
execute if entity @s[tag=IsHeatTail] unless entity @s[tag=IsSootTail] if score #mhdp_dyno_actcount_generic AsaMatrix matches 8.. run function asa_animator:dyno/manager/model/change_to_soot_tail
# 頭部赤熱化
