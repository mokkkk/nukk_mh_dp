...
data modify storage asa_matrix: Rotate set value [142f,0f,-1429f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,4285f,-2143f]
...
data modify storage asa_matrix: Rotate set value [2857f,2857f,-2143f]
