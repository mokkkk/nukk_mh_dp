...
data modify storage asa_matrix: Rotate set value [-8572f,0f,-715f]
...
data modify storage asa_matrix: Rotate set value [-4286f,0f,-715f]
...
data modify storage asa_matrix: Rotate set value [1428f,2142f,714f]
...
data modify storage asa_matrix: Rotate set value [1428f,2857f,714f]
