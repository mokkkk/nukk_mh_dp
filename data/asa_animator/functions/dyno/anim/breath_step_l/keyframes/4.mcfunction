...
data modify storage asa_matrix: Rotate set value [-2858f,2142f,0f]
...
data modify storage asa_matrix: Rotate set value [-715f,2857f,-1429f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,2857f,-1429f]
...
data modify storage asa_matrix: Rotate set value [-2143f,2857f,-2858f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1429f,2857f,-1429f]
