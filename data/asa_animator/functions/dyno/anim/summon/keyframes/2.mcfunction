...
data modify storage asa_matrix: Rotate set value [11000f,1500f,-2000f]
...
data modify storage asa_matrix: Rotate set value [8000f,500f,-2000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [8000f,0f,-1500f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Body0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [7000f,-1000f,-500f]
...
data modify storage asa_matrix: Rotate set value [7000f,2000f,-500f]
