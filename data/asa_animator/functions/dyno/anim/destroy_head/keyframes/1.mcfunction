...
data modify storage asa_matrix: Rotate set value [5714f,4285f,0f]
...
data modify storage asa_matrix: Rotate set value [1428f,8571f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,10000f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1429f,12857f,0f]
