data modify storage asa_matrix: Rotate set value [3888f,0f,555f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2777f,0f,555f]
...
data modify storage asa_matrix: Rotate set value [833f,0f,-556f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [555f,0f,555f]
