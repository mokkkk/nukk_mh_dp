data modify storage asa_matrix: Rotate set value [3055f,0f,277f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2500f,0f,277f]
...
data modify storage asa_matrix: Rotate set value [555f,0f,277f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [555f,0f,-278f]
