data modify storage asa_matrix: Rotate set value [937f,0f,312f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [312f,0f,312f]
...
data modify storage asa_matrix: Rotate set value [468f,0f,-313f]
