...
data modify storage asa_matrix: Rotate set value [-2223f,0f,555f]
...
data modify storage asa_matrix: Rotate set value [277f,0f,-556f]
...
data modify storage asa_matrix: Rotate set value [555f,-1667f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [277f,-2778f,0f]
