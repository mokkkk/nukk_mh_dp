...
data modify storage asa_matrix: Rotate set value [-6667f,0f,-834f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7500f,0f,833f]
...
data modify storage asa_matrix: Rotate set value [-9584f,0f,833f]
