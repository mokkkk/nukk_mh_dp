...
data modify storage asa_matrix: Rotate set value [3333f,-5000f,-1667f]
...
data modify storage asa_matrix: Rotate set value [12500f,-10834f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [12500f,-15834f,-3334f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [19166f,-15000f,-10000f]
