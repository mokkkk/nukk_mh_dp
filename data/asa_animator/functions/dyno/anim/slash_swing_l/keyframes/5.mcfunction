data modify storage asa_matrix: Rotate set value [-6667f,1666f,1666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1667f,1666f,1666f]
...
data modify storage asa_matrix: Rotate set value [-3334f,3333f,-1667f]
...
data modify storage asa_matrix: Rotate set value [0f,3333f,833f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-12500f,3333f,-3334f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-13334f,3333f,-1667f]
...
data modify storage asa_matrix: Rotate set value [-12500f,3333f,-1667f]
