...
data modify storage asa_matrix: Rotate set value [6666f,1666f,1666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadL] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1667f,-1667f,-1667f]
...
data modify storage asa_matrix: Rotate set value [833f,3333f,833f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-13334f,3333f,-3334f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-14167f,3333f,-1667f]
