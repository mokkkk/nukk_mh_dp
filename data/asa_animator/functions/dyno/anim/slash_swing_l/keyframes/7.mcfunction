...
data modify storage asa_matrix: Rotate set value [-3900f,1600f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2600f,-2300f,-1600f]
execute as @e[type=armor_stand,tag=DynoParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2100f,1500f,-1600f]
