...
data modify storage asa_matrix: Rotate set value [-1200f,533f,0f]
...
data modify storage asa_matrix: Rotate set value [-134f,266f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-134f,133f,0f]
...
data modify storage asa_matrix: Rotate set value [-134f,0f,-400f]
