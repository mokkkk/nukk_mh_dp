...
data modify storage asa_matrix: Rotate set value [-4167f,1666f,-834f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7500f,1666f,833f]
