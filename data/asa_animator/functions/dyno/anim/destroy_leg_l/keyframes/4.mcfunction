...
data modify storage asa_matrix: Rotate set value [-334f,-1667f,666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [333f,-1334f,666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1334f,-1667f,666f]
...
data modify storage asa_matrix: Rotate set value [0f,-1667f,666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,-1334f,333f]
...
data modify storage asa_matrix: Rotate set value [-334f,-1334f,333f]
