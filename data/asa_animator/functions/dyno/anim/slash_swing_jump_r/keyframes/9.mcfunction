data modify storage asa_matrix: Rotate set value [-1250f,-313f,1250f]
...
data modify storage asa_matrix: Rotate set value [625f,6187f,0f]
...
data modify storage asa_matrix: Rotate set value [625f,8062f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,8062f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-5125f,10812f,0f]
