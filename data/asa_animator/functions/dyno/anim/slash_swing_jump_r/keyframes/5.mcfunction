...
data modify storage asa_matrix: Rotate set value [-834f,-4167f,-417f]
...
data modify storage asa_matrix: Rotate set value [-11667f,-1667f,1666f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-11250f,-1667f,833f]
...
data modify storage asa_matrix: Rotate set value [-14584f,-1667f,833f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-11667f,-834f,833f]
execute as @e[type=armor_stand,tag=DynoParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-10834f,-834f,833f]
