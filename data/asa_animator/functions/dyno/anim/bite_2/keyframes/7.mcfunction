data modify storage asa_matrix: Rotate set value [-1000f,-7200f,-2000f]
...
data modify storage asa_matrix: Rotate set value [-1500f,-200f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4500f,-2200f,0f]
...
data modify storage asa_matrix: Rotate set value [1500f,-2200f,0f]
