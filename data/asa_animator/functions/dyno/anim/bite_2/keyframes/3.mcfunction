data modify storage asa_matrix: Rotate set value [-4286f,8571f,4285f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4285f,8571f,4285f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadL] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1429f,10000f,0f]
