...
data modify storage asa_matrix: Rotate set value [750f,0f,-625f]
...
data modify storage asa_matrix: Rotate set value [-875f,1250f,-625f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3000f,1250f,0f]
