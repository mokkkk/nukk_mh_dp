data modify storage asa_matrix: Rotate set value [5000f,3500f,-1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [9000f,3500f,-1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadL] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,3500f,-1000f]
...
data modify storage asa_matrix: Rotate set value [3000f,-1500f,-1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [3000f,2500f,-1000f]
