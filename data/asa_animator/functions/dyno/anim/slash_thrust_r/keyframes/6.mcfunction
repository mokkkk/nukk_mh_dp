data modify storage asa_matrix: Rotate set value [2363f,0f,909f]
...
data modify storage asa_matrix: Rotate set value [2818f,1818f,909f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1909f,1818f,909f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1000f,2727f,909f]
...
data modify storage asa_matrix: Rotate set value [1000f,2545f,909f]
