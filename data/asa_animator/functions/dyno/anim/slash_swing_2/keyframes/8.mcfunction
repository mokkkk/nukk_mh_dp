...
data modify storage asa_matrix: Rotate set value [-5600f,4000f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3400f,4000f,1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3100f,4000f,0f]
...
data modify storage asa_matrix: Rotate set value [-400f,4000f,500f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4100f,4000f,0f]
