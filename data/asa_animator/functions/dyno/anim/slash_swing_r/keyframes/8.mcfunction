...
data modify storage asa_matrix: Rotate set value [-1100f,6650f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2900f,9200f,-1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [7150f,12750f,-1000f]
