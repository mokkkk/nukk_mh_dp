...
data modify storage asa_matrix: Rotate set value [-7800f,4000f,-4000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2200f,4000f,-2000f]
...
data modify storage asa_matrix: Rotate set value [-9000f,11000f,-3000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-13000f,12000f,-3000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-15000f,16000f,-3000f]
