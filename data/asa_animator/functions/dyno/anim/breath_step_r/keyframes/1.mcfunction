...
data modify storage asa_matrix: Rotate set value [8428f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [3571f,-2858f,-715f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,-2858f,-715f]
