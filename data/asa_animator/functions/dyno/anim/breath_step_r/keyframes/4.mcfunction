...
data modify storage asa_matrix: Rotate set value [-715f,-2858f,1428f]
...
data modify storage asa_matrix: Rotate set value [-1429f,-2858f,1428f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2143f,-2858f,2857f]
