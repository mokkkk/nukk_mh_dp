...
data modify storage asa_matrix: Rotate set value [-6000f,500f,1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6000f,1500f,1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6000f,2500f,1000f]
