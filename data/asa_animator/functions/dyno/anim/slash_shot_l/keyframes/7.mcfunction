...
data modify storage asa_matrix: Rotate set value [-400f,600f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadL] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,600f,200f]
...
data modify storage asa_matrix: Rotate set value [0f,400f,600f]
