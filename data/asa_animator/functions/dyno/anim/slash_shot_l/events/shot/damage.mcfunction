...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!DynoParts,distance=0..5] run function asa_animator:dyno/anim/slash_shot_l/events/shot/damage_sub
