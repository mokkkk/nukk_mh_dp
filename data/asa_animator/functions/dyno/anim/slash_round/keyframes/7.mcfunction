...
data modify storage asa_matrix: Rotate set value [-2000f,800f,-2000f]
...
data modify storage asa_matrix: Rotate set value [0f,-1200f,-1000f]
...
data modify storage asa_matrix: Rotate set value [3000f,-1200f,-1000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1000f,-1200f,2000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1000f,-1200f,1000f]
