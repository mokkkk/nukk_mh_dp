...
data modify storage asa_matrix: Rotate set value [80f,400f,0f]
...
data modify storage asa_matrix: Rotate set value [280f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-120f,0f,0f]
