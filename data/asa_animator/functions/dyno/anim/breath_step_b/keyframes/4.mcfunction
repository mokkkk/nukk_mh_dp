...
data modify storage asa_matrix: Rotate set value [-6143f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [1214f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-3715f,0f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4071f,0f,0f]
