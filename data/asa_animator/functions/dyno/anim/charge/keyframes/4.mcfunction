data modify storage asa_matrix: Rotate set value [8000f,15000f,-167f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4000f,15000f,-167f]
...
data modify storage asa_matrix: Rotate set value [1000f,-17667f,-30000f]
