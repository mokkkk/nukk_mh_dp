data modify storage asa_matrix: Rotate set value [-9200f,-7000f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7200f,-7000f,0f]
...
data modify storage asa_matrix: Rotate set value [-1700f,1000f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-700f,1500f,0f]
...
data modify storage asa_matrix: Rotate set value [-1200f,7000f,0f]
