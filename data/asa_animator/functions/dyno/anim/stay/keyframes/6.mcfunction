...
data modify storage asa_matrix: Rotate set value [-2955f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [1136f,0f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1591f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-1137f,-910f,0f]
...
data modify storage asa_matrix: Rotate set value [-228f,-1819f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [681f,-2273f,0f]
