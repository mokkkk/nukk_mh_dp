...
data modify storage asa_matrix: Rotate set value [0f,-6000f,3000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2000f,-6000f,3000f]
...
data modify storage asa_matrix: Rotate set value [6000f,-8000f,3000f]
