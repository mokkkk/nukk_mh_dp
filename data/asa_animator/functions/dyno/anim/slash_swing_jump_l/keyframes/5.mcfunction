data modify storage asa_matrix: Rotate set value [-12500f,3333f,833f]
execute as @e[type=armor_stand,tag=DynoParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6667f,3333f,833f]
...
data modify storage asa_matrix: Rotate set value [-7500f,-834f,-834f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6667f,-834f,-834f]
...
data modify storage asa_matrix: Rotate set value [-14584f,1666f,-834f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-10834f,833f,-834f]
execute as @e[type=armor_stand,tag=DynoParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-11667f,833f,-834f]
