...
data modify storage asa_matrix: Rotate set value [-2600f,2000f,2000f]
...
data modify storage asa_matrix: Rotate set value [400f,2000f,2000f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2400f,2000f,2000f]
...
data modify storage asa_matrix: Rotate set value [-2200f,6000f,2000f]
