data modify storage asa_matrix: Rotate set value [1250f,4375f,2500f]
...
data modify storage asa_matrix: Rotate set value [0f,9375f,2500f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,8750f,2500f]
...
data modify storage asa_matrix: Rotate set value [-5625f,11250f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6250f,11250f,-1250f]
