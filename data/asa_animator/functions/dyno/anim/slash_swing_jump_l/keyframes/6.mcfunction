...
data modify storage asa_matrix: Rotate set value [-1200f,-534f,0f]
...
data modify storage asa_matrix: Rotate set value [-134f,-267f,0f]
execute as @e[type=armor_stand,tag=DynoParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-134f,-134f,0f]
