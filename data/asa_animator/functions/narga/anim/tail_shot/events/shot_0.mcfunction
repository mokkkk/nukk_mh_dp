...
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=A] positioned as @s rotated ~ ~ run tp @s ~ ~ ~ ~ ~
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=B] positioned as @s rotated ~-10 ~ run tp @s ~ ~ ~ ~ ~
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=C] positioned as @s rotated ~-20 ~ run tp @s ~ ~ ~ ~ ~
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=D] positioned as @s rotated ~10 ~ run tp @s ~ ~ ~ ~ ~
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=E] positioned as @s rotated ~20 ~ run tp @s ~ ~ ~ ~ ~

execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start,tag=A] run data modify storage mhdp Temp.Rotate set from entity @s Rotation[1]
execute as @e[distance=0..3,type=armor_stand,tag=NargaTail,tag=Start] run data modify entity @s Pose.Head[0] set from storage mhdp Temp.Rotate

tag @e[distance=0..3,type=armor_stand,tag=NargaTail] remove Start
