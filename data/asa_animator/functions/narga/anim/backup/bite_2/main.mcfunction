...
execute if score @s AsaMatrix matches 18..34 run particle block grass_block ~ ~ ~ 1 0.1 1 0 10
execute if score @s AsaMatrix matches 50..55 run particle block grass_block ~ ~ ~ 1 0.1 1 0 10

execute if score @s AsaMatrix matches 52..59 positioned ~ ~2 ~ run function asa_animator:narga/anim/bite_2/events/particle
execute if score @s AsaMatrix matches 50..59 positioned ~ ~1 ~ run function asa_animator:narga/anim/bite_2/events/particle_2
execute if score @s AsaMatrix matches 50..59 positioned ~ ~0.3 ~ run function asa_animator:narga/anim/bite_2/events/particle_3
