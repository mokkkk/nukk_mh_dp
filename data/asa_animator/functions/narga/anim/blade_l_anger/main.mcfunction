...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:narga/anim/blade_l_anger/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:narga/anim/blade_l_anger/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0.6 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:narga/anim/blade_l_anger/keyframes/1
execute if entity @s[scores={AsaMatrix=6..13}] run tp @s ^-0.03125 ^-0.3625 ^0.0625
execute if entity @s[scores={AsaMatrix=14}] run function asa_animator:narga/anim/blade_l_anger/keyframes/2
execute if entity @s[scores={AsaMatrix=14..18}] run tp @s ^-0.05 ^-0.02 ^0.1
execute if entity @s[scores={AsaMatrix=19}] run function asa_animator:narga/anim/blade_l_anger/keyframes/3
execute if entity @s[scores={AsaMatrix=19..30}] run tp @s ^0.02083333 ^0 ^-0.08333334
execute if entity @s[scores={AsaMatrix=31}] run function asa_animator:narga/anim/blade_l_anger/keyframes/4
execute if entity @s[scores={AsaMatrix=31..45}] run tp @s ^0.01666667 ^0 ^-0.06666667 ~0.5 ~
execute if entity @s[scores={AsaMatrix=35..}] run function asa_animator:narga/anim/blade_l_anger/end
