...
execute positioned ^ ^ ^7 run function asa_animator:narga/anim/tail_bitan_anger/events/damage
execute positioned ^ ^ ^8.5 run function asa_animator:narga/anim/tail_bitan_anger/events/damage
execute positioned ^ ^ ^10 run function asa_animator:narga/anim/tail_bitan_anger/events/damage
