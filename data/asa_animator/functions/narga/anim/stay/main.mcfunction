...
execute if score @s AsaMatrix matches 1 if score #mhdp_narga_actcount AsaMatrix matches 1.. run function asa_animator:narga/anim/stay/events/change
execute if score @s AsaMatrix matches 1 if entity @s[tag=IsAnger] run function asa_animator:narga/anim/stay/events/change
