...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!NargaParts,distance=0..6] run function asa_animator:narga/anim/blade_l/events/damage_sub
