...
execute if score @s AsaMatrix matches 1 run function asa_animator:narga/anim/jump_move_r/start
execute if score @s AsaMatrix matches 1 run function asa_animator:narga/anim/jump_move_r/keyframes/0
