...
execute if entity @s[scores={AsaMatrix=77..83}] run tp @s ^0 ^-0.007142857 ^0.01428571
execute if entity @s[scores={AsaMatrix=84}] run function asa_animator:narga/anim/voice/keyframes/9
execute if entity @s[scores={AsaMatrix=84..100}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=101..}] run function asa_animator:narga/anim/voice/end
...
execute if entity @s[scores={AsaMatrix=39}] run playsound minecraft:entity.phantom.bite master @a ~ ~ ~ 3 0.7
execute if entity @s[scores={AsaMatrix=39}] run playsound minecraft:entity.phantom.hurt master @a ~ ~ ~ 3 0.8