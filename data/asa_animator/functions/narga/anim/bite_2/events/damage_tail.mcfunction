...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!NargaParts,distance=0..6] run function asa_animator:narga/anim/bite_2/events/damage_sub_tail
