data modify entity @e[type=armor_stand,tag=NargaParts,tag=WingR,limit=1] ArmorItems[3].tag.CustomModelData set value 10155
...
execute as @e[type=armor_stand,tag=NargaParts,tag=ArmR1,limit=1] at @s run particle block bone_block ~ ~1.4 ~ 0.2 0.2 0.2 0 10
execute as @e[type=armor_stand,tag=NargaParts,tag=ArmR1,limit=1] at @s run loot spawn ~ ~ ~ loot mh_dp:bonus/narga_parts
