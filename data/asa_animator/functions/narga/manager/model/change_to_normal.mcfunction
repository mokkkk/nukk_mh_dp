execute if entity @s[tag=HeadU] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10040
...
execute if entity @s[tag=ArmL1] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10055
execute if entity @s[tag=ArmR1] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10056
execute if entity @s[tag=ArmL2] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10057
execute if entity @s[tag=ArmR2] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10058

execute if entity @s[tag=Tail0] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10059
execute if entity @s[tag=Tail1] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10060
execute if entity @s[tag=Tail2] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10061