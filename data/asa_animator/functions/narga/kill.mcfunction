kill @e[type=armor_stand,tag=NargaRoot]
kill @e[type=armor_stand,tag=NargaParts]
...
scoreboard players reset #mhdp_narga_armr_damage
scoreboard players reset #mhdp_narga_tail_damage
scoreboard players reset #mhdp_narga_move_count
scoreboard players reset #mhdp_narga_actcount
scoreboard players reset #narga_mine_pos
scoreboard players reset #narga_mine_x
scoreboard players reset #narga_mine_y
