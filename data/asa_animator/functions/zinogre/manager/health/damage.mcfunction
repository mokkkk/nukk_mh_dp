...
# 怒り遷移
scoreboard players operation #mhdp_zinogre_anger_damage AsaMatrix += #zinogre_damage AsaMatrix
execute if score #mhdp_zinogre_anger_damage AsaMatrix matches ..0 unless entity @e[type=armor_stand,tag=ZinogreRoot,tag=IsAnger] as @e[type=armor_stand,tag=ZinogreRoot] run function asa_animator:zinogre/manager/start_anger
