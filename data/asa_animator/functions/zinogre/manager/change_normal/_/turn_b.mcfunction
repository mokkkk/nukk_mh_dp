...
# 左右確認
execute unless entity @s[tag=NoRotate] facing entity @e[tag=ZinogreAttackTarget,limit=1] feet positioned ^ ^ ^3.0 rotated as @s positioned ^4.0 ^ ^ if entity @s[distance=..5.0] run tag @s add Right
