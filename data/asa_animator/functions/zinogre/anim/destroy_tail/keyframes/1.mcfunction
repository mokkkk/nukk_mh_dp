data modify storage asa_matrix: Rotate set value [8571f,-1429f,1428f]
...
data modify storage asa_matrix: Rotate set value [5714f,-1429f,1428f]
...
data modify storage asa_matrix: Rotate set value [10000f,-2858f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5714f,-2858f,0f]
...
data modify storage asa_matrix: Rotate set value [5714f,-1429f,5714f]
...
data modify storage asa_matrix: Rotate set value [4285f,-1429f,5714f]
