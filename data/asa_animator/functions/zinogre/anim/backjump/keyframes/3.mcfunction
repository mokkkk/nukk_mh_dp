...
data modify storage asa_matrix: Rotate set value [-5000f,8333f,0f]
...
data modify storage asa_matrix: Rotate set value [-10000f,8333f,0f]
...
data modify storage asa_matrix: Rotate set value [-4167f,6666f,0f]
