...
execute if score #asa_zinogre_tick_current AsaMatrix >= #asa_zinogre_tick_end AsaMatrix run function asa_animator:zinogre/anim/backjump/keyframes/manager
function asa_animator:zinogre/anim/backjump/events/manager
