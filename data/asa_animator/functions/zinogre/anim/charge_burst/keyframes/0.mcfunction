...
data modify storage asa_matrix: Rotate set value [9166f,-3334f,0f]
...
data modify storage asa_matrix: Rotate set value [5000f,1666f,-4167f]
...
data modify storage asa_matrix: Rotate set value [8333f,1666f,1666f]
