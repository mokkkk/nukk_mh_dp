data modify storage asa_matrix: Rotate set value [-518f,0f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-173f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [172f,0f,0f]
