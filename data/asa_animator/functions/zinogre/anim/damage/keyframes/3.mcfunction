data modify storage asa_matrix: Rotate set value [0f,0f,-3500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1000f,0f,-3500f]
...
data modify storage asa_matrix: Rotate set value [-200f,0f,-3500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-700f,0f,-3500f]
...
data modify storage asa_matrix: Rotate set value [4600f,0f,-500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2200f,0f,-6500f]
