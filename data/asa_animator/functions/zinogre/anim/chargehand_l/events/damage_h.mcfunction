...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ZinogreParts,distance=..4.9] run function asa_animator:zinogre/anim/chargehand_l/events/damage_sub
