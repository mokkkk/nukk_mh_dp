...
# 地上にmarkerセット
summon marker ^ ^ ^15 {Tags:["ZinogreMovePos"]}
execute if entity @e[tag=ZinogreAttackTarget,distance=..16] facing entity @e[tag=ZinogreAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=ZinogreAttackTarget] positioned as @s run tp @e[type=marker,tag=ZinogreMovePos] ^ ^ ^-5
