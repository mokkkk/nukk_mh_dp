...
data modify storage asa_matrix: Rotate set value [5000f,-10000f,-6000f]
...
data modify storage asa_matrix: Rotate set value [3000f,-10000f,-4000f]
...
data modify storage asa_matrix: Rotate set value [1000f,-10000f,-1000f]
...
data modify storage asa_matrix: Rotate set value [-1800f,-10600f,2000f]
