...
data modify storage asa_matrix: Rotate set value [0f,10000f,5000f]
...
data modify storage asa_matrix: Rotate set value [-22500f,-7500f,5000f]
...
data modify storage asa_matrix: Rotate set value [10000f,5000f,-2500f]
