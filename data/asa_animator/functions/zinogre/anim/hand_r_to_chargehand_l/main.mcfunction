...
# 確立で遷移
    execute if entity @s[tag=IsAnger,tag=!IsHandC2,scores={AsaMatrix=45}] if predicate asa_animator:random/050 run function asa_animator:zinogre/anim/hand_r_to_chargehand_l/events/change
