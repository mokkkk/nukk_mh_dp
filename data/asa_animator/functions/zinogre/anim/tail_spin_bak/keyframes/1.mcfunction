...
scoreboard players set #asa_zinogre_move_pos_x AsaMatrix -5
...
scoreboard players set #asa_zinogre_move_pos_z AsaMatrix -5
...
scoreboard players set #asa_temp AsaMatrix -50
