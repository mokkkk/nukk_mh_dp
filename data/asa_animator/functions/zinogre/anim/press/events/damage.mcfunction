...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ZinogreParts,distance=..5.5] run function asa_animator:zinogre/anim/press/events/damage_sub
