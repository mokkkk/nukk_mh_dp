...
data modify storage asa_matrix: Rotate set value [833f,-6667f,833f]
...
data modify storage asa_matrix: Rotate set value [11666f,-1667f,0f]
...
data modify storage asa_matrix: Rotate set value [-26667f,3333f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-20000f,-1667f,0f]
