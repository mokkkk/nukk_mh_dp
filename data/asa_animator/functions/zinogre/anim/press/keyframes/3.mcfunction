...
data modify storage asa_matrix: Rotate set value [0f,-584f,0f]
...
data modify storage asa_matrix: Rotate set value [1916f,416f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [250f,416f,416f]
