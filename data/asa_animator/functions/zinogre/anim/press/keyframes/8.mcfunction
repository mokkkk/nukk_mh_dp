data modify storage asa_matrix: Rotate set value [9700f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [8700f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [2200f,-5000f,0f]
