data modify storage asa_matrix: Rotate set value [-556f,-1112f,-1112f]
...
data modify storage asa_matrix: Rotate set value [-834f,1666f,555f]
...
data modify storage asa_matrix: Rotate set value [-278f,1666f,555f]
