data modify storage asa_matrix: Rotate set value [15000f,1250f,-2500f]
...
data modify storage asa_matrix: Rotate set value [7500f,-1250f,-3750f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [7500f,-1875f,-5000f]
...
data modify storage asa_matrix: Rotate set value [11250f,-2500f,-2500f]
...
data modify storage asa_matrix: Rotate set value [7500f,-2500f,-3750f]
...
data modify storage asa_matrix: Rotate set value [6250f,-1250f,-2500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [12500f,-7500f,-3750f]
