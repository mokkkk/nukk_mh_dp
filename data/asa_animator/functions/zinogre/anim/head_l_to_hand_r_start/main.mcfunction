...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/head_l_to_hand_r_start/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/head_l_to_hand_r_start/keyframes/0
...
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:zinogre/anim/head_l_to_hand_r_start/keyframes/1
execute if entity @s[scores={AsaMatrix=9..12}] run tp @s ^0 ^0 ^ ~-24 ~
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:zinogre/anim/head_l_to_hand_r_start/keyframes/2
...
execute if entity @s[scores={AsaMatrix=57..}] run function asa_animator:zinogre/anim/head_l_to_hand_r_start/end
