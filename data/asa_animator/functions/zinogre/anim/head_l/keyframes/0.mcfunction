...
data modify storage asa_matrix: Rotate set value [1666f,-8334f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5000f,-11667f,0f]
