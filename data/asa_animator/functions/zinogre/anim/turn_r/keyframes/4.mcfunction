data modify storage asa_matrix: Rotate set value [-1112f,0f,-556f]
...
data modify storage asa_matrix: Rotate set value [1111f,-1112f,555f]
...
data modify storage asa_matrix: Rotate set value [-2223f,-556f,1111f]
...
data modify storage asa_matrix: Rotate set value [-1112f,2777f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1666f,-556f,0f]
