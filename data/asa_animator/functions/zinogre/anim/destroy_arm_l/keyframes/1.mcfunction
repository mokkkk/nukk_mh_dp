data modify storage asa_matrix: Rotate set value [-22000f,6000f,-2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-19000f,6000f,-2000f]
...
data modify storage asa_matrix: Rotate set value [-5500f,0f,-4000f]
...
data modify storage asa_matrix: Rotate set value [4000f,4500f,-2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4000f,6500f,-2000f]
...
data modify storage asa_matrix: Rotate set value [-19000f,4000f,-4000f]
