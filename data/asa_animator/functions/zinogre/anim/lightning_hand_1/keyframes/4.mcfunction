...
data modify storage asa_matrix: Rotate set value [-2308f,615f,0f]
...
data modify storage asa_matrix: Rotate set value [-154f,615f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-231f,153f,0f]
