...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/head_r_to_hand_l_start/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/head_r_to_hand_l_start/keyframes/0
...
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:zinogre/anim/head_r_to_hand_l_start/keyframes/1
execute if entity @s[scores={AsaMatrix=9..12}] run tp @s ^0 ^0 ^ ~24 ~
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:zinogre/anim/head_r_to_hand_l_start/keyframes/2
...
execute if entity @s[scores={AsaMatrix=57..}] run function asa_animator:zinogre/anim/head_r_to_hand_l_start/end
...
execute if entity @s[scores={AsaMatrix=31..38}] run function asa_animator:zinogre/manager/rotate
execute if entity @s[scores={AsaMatrix=31..34}] at @s unless entity @e[tag=ZinogreAttackTarget,distance=0..5.5] run tp @s ^ ^ ^1.3 ~ ~
execute if entity @s[scores={AsaMatrix=35..42}] at @s unless entity @e[tag=ZinogreAttackTarget,distance=0..5.5] run tp @s ^ ^ ^1 ~ ~
