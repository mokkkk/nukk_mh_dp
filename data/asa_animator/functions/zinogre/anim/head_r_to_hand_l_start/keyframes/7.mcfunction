...
data modify storage asa_matrix: Rotate set value [1250f,10000f,5000f]
...
data modify storage asa_matrix: Rotate set value [61250f,-10000f,12500f]
...
data modify storage asa_matrix: Rotate set value [35000f,-20000f,10000f]
