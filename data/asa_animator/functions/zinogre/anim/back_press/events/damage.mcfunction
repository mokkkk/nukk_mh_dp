...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ZinogreParts,distance=..6.0] run function asa_animator:zinogre/anim/back_press/events/damage_sub
