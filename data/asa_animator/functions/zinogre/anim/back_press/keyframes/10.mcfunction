data modify storage asa_matrix: Rotate set value [296f,0f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [74f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-149f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [259f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-112f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [814f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [74f,0f,185f]
...
data modify storage asa_matrix: Rotate set value [814f,0f,-186f]
