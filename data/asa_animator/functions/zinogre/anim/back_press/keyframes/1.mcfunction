data modify storage asa_matrix: Rotate set value [-26667f,0f,3333f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-30000f,0f,3333f]
...
data modify storage asa_matrix: Rotate set value [-6667f,3333f,-10000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [16666f,3333f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [6666f,3333f,-10000f]
