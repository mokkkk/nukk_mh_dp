...
data modify storage asa_matrix: Rotate set value [-400f,0f,-6000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2400f,0f,-8000f]
