...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/end_thunder_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^-0.5 ^0.03 ^-0.06 ~2 ~
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^-0.2 ^0.03 ^-0.06 ~2 ~
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/2
execute if entity @s[scores={AsaMatrix=11..15}] run tp @s ^-0.05 ^0.06 ^0
execute if entity @s[scores={AsaMatrix=16}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/3
execute if entity @s[scores={AsaMatrix=16..23}] run tp @s ^0 ^-0.1 ^0.05
execute if entity @s[scores={AsaMatrix=24}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/4
execute if entity @s[scores={AsaMatrix=24..42}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=43}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/5
execute if entity @s[scores={AsaMatrix=43..56}] run tp @s ^0 ^0.007142857 ^0.007142857 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=57}] run function asa_animator:zinogre/anim/end_thunder_l/keyframes/6
execute if entity @s[scores={AsaMatrix=57..70}] run tp @s ^0 ^0.007142857 ^0.007142857 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=71..}] run function asa_animator:zinogre/anim/end_thunder_l/end
