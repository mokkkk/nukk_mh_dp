data modify storage asa_matrix: Rotate set value [-1400f,3000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2600f,3000f,0f]
...
data modify storage asa_matrix: Rotate set value [4600f,5000f,0f]
