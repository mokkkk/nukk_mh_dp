data modify storage asa_matrix: Rotate set value [34000f,-20000f,-5000f]
...
data modify storage asa_matrix: Rotate set value [12500f,-7500f,0f]
...
data modify storage asa_matrix: Rotate set value [-20000f,-7000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [11250f,-15000f,-2500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [8750f,-15000f,6250f]
...
data modify storage asa_matrix: Rotate set value [-5500f,-10000f,-500f]
...
data modify storage asa_matrix: Rotate set value [-3750f,-10000f,-3000f]
