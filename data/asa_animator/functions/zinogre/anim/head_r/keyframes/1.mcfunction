data modify storage asa_matrix: Rotate set value [-12858f,2857f,0f]
...
data modify storage asa_matrix: Rotate set value [-11429f,2857f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7143f,2857f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,3571f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-715f,-715f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,4285f,714f]
...
data modify storage asa_matrix: Rotate set value [357f,4285f,714f]
