...
data modify storage asa_matrix: Rotate set value [3333f,6666f,-3334f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1667f,13333f,-6667f]
...
data modify storage asa_matrix: Rotate set value [-3334f,0f,-6667f]
