...
data modify storage asa_matrix: Rotate set value [2375f,-2084f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [791f,-2500f,0f]
...
data modify storage asa_matrix: Rotate set value [-1042f,-417f,0f]
