...
data modify storage asa_matrix: Rotate set value [15000f,2000f,2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [18400f,2000f,-2000f]
