data modify storage asa_matrix: Rotate set value [-5313f,312f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-5000f,312f,0f]
...
data modify storage asa_matrix: Rotate set value [-5125f,500f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,687f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,1062f,0f]
...
data modify storage asa_matrix: Rotate set value [-6188f,3625f,-5000f]
