...
data modify storage asa_matrix: Rotate set value [3461f,-770f,0f]
...
data modify storage asa_matrix: Rotate set value [-231f,230f,0f]
...
data modify storage asa_matrix: Rotate set value [384f,-385f,0f]
...
data modify storage asa_matrix: Rotate set value [76f,-385f,0f]
