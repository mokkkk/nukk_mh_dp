...
data modify storage asa_matrix: Rotate set value [-1000f,-7000f,9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [13000f,-7000f,2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1500f,-7000f,9000f]
...
data modify storage asa_matrix: Rotate set value [5500f,-7000f,10000f]
...
data modify storage asa_matrix: Rotate set value [9500f,-7000f,11500f]
...
data modify storage asa_matrix: Rotate set value [9500f,-4500f,3000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5000f,-4600f,2500f]
...
data modify storage asa_matrix: Rotate set value [700f,-9800f,0f]
...
data modify storage asa_matrix: Rotate set value [-100f,-9300f,0f]
