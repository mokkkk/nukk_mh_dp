...
execute if entity @s[tag=IsThunder] at @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run particle dust 1 1000000000 1000000000 1 ~ ~1.35 ~ 0.5 0.5 0.5 0 10
execute if entity @s[tag=IsThunder] run particle end_rod ~ ~3 ~ 2 2 2 0.1 3