...
data modify storage asa_matrix: Rotate set value [-167f,-417f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [166f,-417f,0f]
...
data modify storage asa_matrix: Rotate set value [-250f,-417f,0f]
...
data modify storage asa_matrix: Rotate set value [166f,-584f,0f]
...
data modify storage asa_matrix: Rotate set value [500f,-917f,0f]
