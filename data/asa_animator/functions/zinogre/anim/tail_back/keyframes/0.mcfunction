data modify storage asa_matrix: Rotate set value [-6000f,-16000f,2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2000f,-16000f,2000f]
...
data modify storage asa_matrix: Rotate set value [-5000f,-6000f,2000f]
