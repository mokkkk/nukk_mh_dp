...
data modify storage asa_matrix: Rotate set value [8333f,10000f,5000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5000f,-5000f,-3334f]
...
data modify storage asa_matrix: Rotate set value [-10000f,3333f,1666f]
