...
data modify storage asa_matrix: Rotate set value [0f,17500f,10000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2500f,17500f,10000f]
...
data modify storage asa_matrix: Rotate set value [17500f,12500f,5000f]
...
data modify storage asa_matrix: Rotate set value [11250f,2500f,0f]
...
data modify storage asa_matrix: Rotate set value [5000f,-20000f,10000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-13750f,0f,-5000f]
