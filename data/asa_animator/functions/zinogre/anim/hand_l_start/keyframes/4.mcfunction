...
data modify storage asa_matrix: Rotate set value [1666f,13333f,-1667f]
...
data modify storage asa_matrix: Rotate set value [16333f,17666f,-16667f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [13333f,-1667f,0f]
