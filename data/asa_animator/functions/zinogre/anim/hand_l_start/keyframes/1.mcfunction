data modify storage asa_matrix: Rotate set value [-5313f,-313f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-5000f,-313f,0f]
...
data modify storage asa_matrix: Rotate set value [-5000f,-688f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-1063f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-438f,0f]
