...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/sault/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/sault/keyframes/0
execute if entity @s[scores={AsaMatrix=1..8}] run tp @s ^0 ^0 ^-0.0125
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:zinogre/anim/sault/keyframes/1
execute if entity @s[scores={AsaMatrix=9..12}] run tp @s ^0 ^0 ^-0.0125
execute if entity @s[scores={AsaMatrix=13}] run function asa_animator:zinogre/anim/sault/keyframes/2
execute if entity @s[scores={AsaMatrix=13..35}] run tp @s ^0 ^0 ^-0.002173913
execute if entity @s[scores={AsaMatrix=36}] run function asa_animator:zinogre/anim/sault/keyframes/3
execute if entity @s[scores={AsaMatrix=36..40}] run tp @s ^0 ^-0.04 ^0.8 ~3 ~
execute if entity @s[scores={AsaMatrix=41}] run function asa_animator:zinogre/anim/sault/keyframes/4
execute if entity @s[scores={AsaMatrix=41..45}] run tp @s ^0.55 ^0.18 ^0.45 ~20 ~
execute if entity @s[scores={AsaMatrix=46}] run function asa_animator:zinogre/anim/sault/keyframes/5
execute if entity @s[scores={AsaMatrix=46..55}] run tp @s ^0.55 ^0.1 ^0.45 ~22 ~
execute if entity @s[scores={AsaMatrix=56}] run function asa_animator:zinogre/anim/sault/keyframes/6
execute if entity @s[scores={AsaMatrix=56..65}] run tp @s ^0.55 ^0.01999999 ^0.45 ~24 ~
execute if entity @s[scores={AsaMatrix=66}] run function asa_animator:zinogre/anim/sault/keyframes/7
execute if entity @s[scores={AsaMatrix=66..70}] run tp @s ^0 ^1.28 ^0 ~26 ~
execute if entity @s[scores={AsaMatrix=71}] run function asa_animator:zinogre/anim/sault/keyframes/8
execute if entity @s[scores={AsaMatrix=71..75}] run tp @s ^0 ^-0.1200001 ^0 ~32 ~
execute if entity @s[scores={AsaMatrix=76}] run function asa_animator:zinogre/anim/sault/keyframes/9
execute if entity @s[scores={AsaMatrix=76..80}] run tp @s ^-0.1 ^-0.89 ^-0.125 ~16 ~
execute if entity @s[scores={AsaMatrix=81}] run function asa_animator:zinogre/anim/sault/keyframes/10
execute if entity @s[scores={AsaMatrix=81..85}] run tp @s ^-0.1 ^-0.77 ^-0.125 ~13 ~
execute if entity @s[scores={AsaMatrix=86}] run function asa_animator:zinogre/anim/sault/keyframes/11
...
execute if entity @s[scores={AsaMatrix=99}] run function asa_animator:zinogre/anim/sault/keyframes/12
execute if entity @s[scores={AsaMatrix=99..118}] run tp @s ^0 ^0 ^-0.05 ~0.5 ~
execute if entity @s[scores={AsaMatrix=119}] run function asa_animator:zinogre/anim/sault/keyframes/13
execute if entity @s[scores={AsaMatrix=119..138}] run tp @s ^0.05 ^0.03 ^0.0125 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=139..}] run function asa_animator:zinogre/anim/sault/end
...
# 攻撃
    execute if entity @s[scores={AsaMatrix=45..75}] at @e[type=armor_stand,tag=ZinogreParts,tag=Tail3] run function asa_animator:zinogre/anim/sault/events/damage
