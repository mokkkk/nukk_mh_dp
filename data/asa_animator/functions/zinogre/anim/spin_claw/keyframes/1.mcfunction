...
data modify storage asa_matrix: Rotate set value [-5715f,1428f,-2858f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2858f,714f,-2858f]
...
data modify storage asa_matrix: Rotate set value [-1429f,-1429f,2857f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3572f,-1429f,-1429f]
...
data modify storage asa_matrix: Rotate set value [714f,-1429f,-1429f]
...
data modify storage asa_matrix: Rotate set value [-715f,-12858f,-8572f]
...
data modify storage asa_matrix: Rotate set value [9285f,-12858f,-8572f]
