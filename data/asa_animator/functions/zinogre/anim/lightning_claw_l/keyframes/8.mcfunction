data modify storage asa_matrix: Rotate set value [0f,-1000f,25000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-5000f,-1000f,25000f]
...
data modify storage asa_matrix: Rotate set value [0f,-1000f,35000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Body1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7500f,-1000f,30000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-7500f,-1000f,40000f]
...
data modify storage asa_matrix: Rotate set value [-2500f,-1000f,40000f]
