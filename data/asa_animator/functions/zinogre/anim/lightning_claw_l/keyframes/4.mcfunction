...
data modify storage asa_matrix: Rotate set value [2000f,-5500f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4000f,-500f,0f]
