data modify storage asa_matrix: Rotate set value [-13750f,6250f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-8125f,6250f,0f]
...
data modify storage asa_matrix: Rotate set value [-8125f,5000f,0f]
...
data modify storage asa_matrix: Rotate set value [-5625f,5000f,-2500f]
