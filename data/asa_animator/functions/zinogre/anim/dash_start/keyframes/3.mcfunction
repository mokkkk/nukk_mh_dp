...
data modify storage asa_matrix: Rotate set value [11666f,0f,3333f]
...
data modify storage asa_matrix: Rotate set value [11666f,0f,6666f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [11666f,0f,-3334f]
