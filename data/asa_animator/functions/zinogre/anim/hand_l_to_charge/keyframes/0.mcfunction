...
data modify storage asa_matrix: Rotate set value [3500f,-6000f,1000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4000f,-5000f,1000f]
...
data modify storage asa_matrix: Rotate set value [-6000f,1500f,0f]
...
data modify storage asa_matrix: Rotate set value [-1800f,2000f,1000f]
...
data modify storage asa_matrix: Rotate set value [5200f,4000f,1000f]
