...
data modify storage asa_matrix: Rotate set value [-938f,-625f,0f]
...
data modify storage asa_matrix: Rotate set value [-2500f,-313f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-313f,-2188f,0f]
...
data modify storage asa_matrix: Rotate set value [-2188f,-2188f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-313f,0f]
...
data modify storage asa_matrix: Rotate set value [-938f,-1250f,0f]
