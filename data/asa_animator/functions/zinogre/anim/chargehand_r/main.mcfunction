...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/chargehand_r/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^-0.04
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/1
execute if entity @s[scores={AsaMatrix=6..9}] run tp @s ^0 ^0.0375 ^0.025
execute if entity @s[scores={AsaMatrix=10}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/2
execute if entity @s[scores={AsaMatrix=10..15}] run tp @s ^0 ^0.0125 ^0.025
execute if entity @s[scores={AsaMatrix=16}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/3
execute if entity @s[scores={AsaMatrix=16..24}] run tp @s ^0 ^0.004545454 ^0
execute if entity @s[scores={AsaMatrix=25}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/4
execute if entity @s[scores={AsaMatrix=25..35}] run tp @s ^0 ^0.004545456 ^0
execute if entity @s[scores={AsaMatrix=36}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/5
execute if entity @s[scores={AsaMatrix=36..38}] run tp @s ^0 ^0.03333333 ^0
execute if entity @s[scores={AsaMatrix=39}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/6
execute if entity @s[scores={AsaMatrix=39..40}] run tp @s ^0 ^-0.05 ^0
execute if entity @s[scores={AsaMatrix=41}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/7
execute if entity @s[scores={AsaMatrix=41..42}] run tp @s ^0 ^-0.5 ^0
execute if entity @s[scores={AsaMatrix=43}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/8
execute if entity @s[scores={AsaMatrix=43..44}] run tp @s ^0 ^0.55 ^0.025
execute if entity @s[scores={AsaMatrix=45}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/9
execute if entity @s[scores={AsaMatrix=45..47}] run tp @s ^0 ^-0.3 ^0.01666667
execute if entity @s[scores={AsaMatrix=48}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/10
execute if entity @s[scores={AsaMatrix=48..56}] run tp @s ^0 ^0 ^0 ~0.2 ~
execute if entity @s[scores={AsaMatrix=57}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/11
execute if entity @s[scores={AsaMatrix=57..68}] run tp @s ^0 ^0.006510417 ^-0.01484375
execute if entity @s[scores={AsaMatrix=69}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/12
execute if entity @s[scores={AsaMatrix=69..76}] run tp @s ^0 ^0.04101563 ^-0.05976562
execute if entity @s[scores={AsaMatrix=77}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/13
execute if entity @s[scores={AsaMatrix=77..82}] run tp @s ^0 ^0.01041667 ^-0.02708334
execute if entity @s[scores={AsaMatrix=83}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/14
execute if entity @s[scores={AsaMatrix=83..86}] run tp @s ^0 ^0.0078125 ^-0.0203125
execute if entity @s[scores={AsaMatrix=87}] run function asa_animator:zinogre/anim/chargehand_r/keyframes/15
execute if entity @s[scores={AsaMatrix=87..90}] run tp @s ^0 ^0 ^-0.05
execute if entity @s[scores={AsaMatrix=91..}] run function asa_animator:zinogre/anim/chargehand_r/end
