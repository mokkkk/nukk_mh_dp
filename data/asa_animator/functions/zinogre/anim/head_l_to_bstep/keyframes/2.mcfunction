data modify storage asa_matrix: Rotate set value [-3000f,-14000f,-2000f]
...
data modify storage asa_matrix: Rotate set value [-17000f,4000f,0f]
...
data modify storage asa_matrix: Rotate set value [-6000f,5000f,0f]
...
data modify storage asa_matrix: Rotate set value [9000f,-2000f,-2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [16500f,2000f,-2000f]
