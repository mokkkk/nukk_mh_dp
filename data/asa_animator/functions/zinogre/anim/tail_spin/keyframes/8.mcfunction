data modify storage asa_matrix: Rotate set value [600f,750f,0f]
...
data modify storage asa_matrix: Rotate set value [-400f,1250f,0f]
...
data modify storage asa_matrix: Rotate set value [-900f,1750f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1400f,1750f,0f]
