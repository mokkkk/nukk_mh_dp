data modify storage asa_matrix: Rotate set value [1400f,-400f,2000f]
...
data modify storage asa_matrix: Rotate set value [-3600f,-400f,2000f]
...
data modify storage asa_matrix: Rotate set value [-6000f,-400f,2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4000f,3600f,2000f]
