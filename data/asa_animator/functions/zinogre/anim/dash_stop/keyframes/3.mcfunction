...
data modify storage asa_matrix: Rotate set value [3000f,-500f,1500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2500f,-500f,-1500f]
...
data modify storage asa_matrix: Rotate set value [750f,-500f,-1500f]
