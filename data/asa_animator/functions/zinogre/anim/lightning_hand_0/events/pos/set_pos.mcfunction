...
# 地上にmarkerセット
summon marker ^ ^10 ^10 {Tags:["ZinogreMovePos"]}
execute facing entity @e[tag=ZinogreAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=ZinogreAttackTarget] positioned as @s run tp @e[type=marker,tag=ZinogreMovePos] ^ ^5 ^-5
...
execute as @e[type=marker,tag=ZinogreMovePos,limit=1] at @s run tp @s ~ ~-1.5 ~
...
scoreboard players set #zinogre_height_target AsaMatrix 19
scoreboard players operation #zinogre_mine_x AsaMatrix /= #zinogre_height_target AsaMatrix
scoreboard players operation #zinogre_mine_y AsaMatrix /= #zinogre_height_target AsaMatrix
scoreboard players operation #zinogre_mine_z AsaMatrix /= #zinogre_height_target AsaMatrix
