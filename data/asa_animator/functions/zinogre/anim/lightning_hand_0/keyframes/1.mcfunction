...
data modify storage asa_matrix: Rotate set value [-5000f,5000f,1000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail3] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [8000f,-4000f,-7000f]
...
data modify storage asa_matrix: Rotate set value [4000f,-4000f,-5000f]
