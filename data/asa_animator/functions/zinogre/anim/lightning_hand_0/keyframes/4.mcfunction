...
data modify storage asa_matrix: Rotate set value [4285f,5000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,6000f,0f]
