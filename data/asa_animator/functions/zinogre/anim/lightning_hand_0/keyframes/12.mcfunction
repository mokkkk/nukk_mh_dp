...
data modify storage asa_matrix: Rotate set value [16875f,-2500f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5625f,-625f,0f]
