data modify storage asa_matrix: Rotate set value [-1112f,0f,555f]
...
data modify storage asa_matrix: Rotate set value [1111f,1111f,-556f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1111f,0f,-556f]
...
data modify storage asa_matrix: Rotate set value [-1112f,555f,0f]
...
data modify storage asa_matrix: Rotate set value [-1667f,1111f,0f]
...
data modify storage asa_matrix: Rotate set value [-2223f,555f,-1112f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1666f,555f,0f]
