data modify storage asa_matrix: Rotate set value [100f,-300f,0f]
...
data modify storage asa_matrix: Rotate set value [-1000f,-1300f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2000f,-1800f,0f]
