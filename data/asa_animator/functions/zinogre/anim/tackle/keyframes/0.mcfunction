data modify storage asa_matrix: Rotate set value [-2700f,0f,1000f]
...
data modify storage asa_matrix: Rotate set value [-4200f,6000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4200f,11000f,0f]
