...
data modify storage asa_matrix: Rotate set value [20000f,4000f,8000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadL] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [16000f,4000f,8000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [12000f,4000f,8000f]
...
data modify storage asa_matrix: Rotate set value [-10000f,4000f,4000f]
...
data modify storage asa_matrix: Rotate set value [10000f,4000f,8000f]
