data modify storage asa_matrix: Rotate set value [-358f,-715f,-715f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-715f,-715f,-715f]
...
data modify storage asa_matrix: Rotate set value [-715f,714f,-358f]
...
data modify storage asa_matrix: Rotate set value [714f,1785f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1072f,1428f,-715f]
