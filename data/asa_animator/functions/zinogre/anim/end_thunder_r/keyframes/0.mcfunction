...
data modify storage asa_matrix: Rotate set value [9000f,2000f,4000f]
...
data modify storage asa_matrix: Rotate set value [4000f,-6500f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4000f,-8500f,0f]
...
data modify storage asa_matrix: Rotate set value [5000f,0f,6000f]
...
data modify storage asa_matrix: Rotate set value [13000f,0f,4000f]
