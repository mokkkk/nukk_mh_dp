...
data modify storage asa_matrix: Rotate set value [6666f,0f,3333f]
...
data modify storage asa_matrix: Rotate set value [3333f,-6667f,3333f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1667f,-13334f,6666f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3334f,-20000f,10000f]
