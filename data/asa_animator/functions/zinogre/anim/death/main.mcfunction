...
execute if score @s AsaMatrix matches 61 unless entity @s[tag=DestroyHead] as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10086
execute if score @s AsaMatrix matches 61 if entity @s[tag=DestroyHead] as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run data modify entity @s ArmorItems[3].tag.CustomModelData set value 10298