...
data modify storage asa_matrix: Rotate set value [1000f,-14000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2000f,-14000f,0f]
...
data modify storage asa_matrix: Rotate set value [-3000f,-11000f,0f]
...
data modify storage asa_matrix: Rotate set value [-15000f,-10000f,1000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [11500f,-13000f,-1000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [7000f,-24000f,3000f]
...
data modify storage asa_matrix: Rotate set value [3000f,-24000f,3000f]
