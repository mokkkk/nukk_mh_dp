...
data modify storage asa_matrix: Rotate set value [20000f,-4000f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [24000f,-4000f,0f]
...
data modify storage asa_matrix: Rotate set value [9000f,14000f,0f]
