...
execute positioned ^ ^ ^2 as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ZinogreParts,distance=..5.5] positioned as @e[type=armor_stand,tag=ZinogreRoot] run function asa_animator:zinogre/anim/sault_l/events/damage_sub
