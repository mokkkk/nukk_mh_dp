data modify storage asa_matrix: Rotate set value [-1033f,141f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-870f,141f,0f]
...
data modify storage asa_matrix: Rotate set value [-935f,43f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1305f,-55f,0f]
...
data modify storage asa_matrix: Rotate set value [684f,65f,-435f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-218f,-87f,0f]
