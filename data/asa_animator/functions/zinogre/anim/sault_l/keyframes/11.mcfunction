...
data modify storage asa_matrix: Rotate set value [3461f,769f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-231f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-385f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-1924f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,-3462f,0f]
...
data modify storage asa_matrix: Rotate set value [-231f,-231f,0f]
...
data modify storage asa_matrix: Rotate set value [384f,384f,0f]
...
data modify storage asa_matrix: Rotate set value [76f,384f,0f]
