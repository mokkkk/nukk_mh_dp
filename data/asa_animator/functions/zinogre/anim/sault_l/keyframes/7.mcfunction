...
data modify storage asa_matrix: Rotate set value [-2000f,-1000f,-18000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [11000f,0f,-18000f]
...
data modify storage asa_matrix: Rotate set value [-5000f,0f,-21000f]
...
data modify storage asa_matrix: Rotate set value [-3000f,0f,-25000f]
