data modify storage asa_matrix: Rotate set value [0f,0f,20000f]
...
data modify storage asa_matrix: Rotate set value [0f,6666f,20000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,13333f,20000f]
...
data modify storage asa_matrix: Rotate set value [0f,30000f,20000f]
...
data modify storage asa_matrix: Rotate set value [5000f,28333f,20000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [10000f,26666f,20000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [15000f,25000f,20000f]
