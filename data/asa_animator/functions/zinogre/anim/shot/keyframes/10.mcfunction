data modify storage asa_matrix: Rotate set value [1700f,0f,700f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1300f,0f,700f]
...
data modify storage asa_matrix: Rotate set value [400f,0f,-200f]
...
data modify storage asa_matrix: Rotate set value [400f,0f,-100f]
...
data modify storage asa_matrix: Rotate set value [300f,0f,-100f]
