...
data modify storage asa_matrix: Rotate set value [0f,-20000f,-20000f]
...
data modify storage asa_matrix: Rotate set value [-3334f,-20000f,-20000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6667f,-20000f,-20000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-10000f,-20000f,-20000f]
