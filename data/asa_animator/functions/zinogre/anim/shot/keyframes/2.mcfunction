...
data modify storage asa_matrix: Rotate set value [4812f,-3750f,23750f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4813f,-3750f,23750f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [250f,-3750f,23125f]
