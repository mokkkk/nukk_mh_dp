...
data modify storage asa_matrix: Rotate set value [-715f,-358f,0f]
...
data modify storage asa_matrix: Rotate set value [714f,0f,-358f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,0f,-1072f]
...
data modify storage asa_matrix: Rotate set value [-1215f,-715f,0f]
...
data modify storage asa_matrix: Rotate set value [-286f,-715f,714f]
