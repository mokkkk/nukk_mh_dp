...
data modify storage asa_matrix: Rotate set value [-715f,357f,0f]
...
data modify storage asa_matrix: Rotate set value [714f,0f,357f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1428f,0f,1071f]
...
data modify storage asa_matrix: Rotate set value [-286f,714f,-715f]
