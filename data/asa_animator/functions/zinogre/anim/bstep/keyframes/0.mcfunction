data modify storage asa_matrix: Rotate set value [1428f,1428f,1428f]
...
data modify storage asa_matrix: Rotate set value [2857f,-715f,0f]
...
data modify storage asa_matrix: Rotate set value [5714f,-1429f,0f]
...
data modify storage asa_matrix: Rotate set value [4285f,-1429f,-2858f]
