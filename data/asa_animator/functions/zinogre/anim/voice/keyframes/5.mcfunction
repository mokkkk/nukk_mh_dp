...
data modify storage asa_matrix: Rotate set value [-2000f,2666f,0f]
...
data modify storage asa_matrix: Rotate set value [-1000f,-1000f,666f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [333f,-1000f,666f]
...
data modify storage asa_matrix: Rotate set value [0f,-1000f,666f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3000f,-1000f,666f]
