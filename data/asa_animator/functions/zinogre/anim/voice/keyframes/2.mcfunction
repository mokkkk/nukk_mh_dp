...
data modify storage asa_matrix: Rotate set value [6666f,3333f,-3334f]
...
data modify storage asa_matrix: Rotate set value [2500f,-8334f,0f]
...
data modify storage asa_matrix: Rotate set value [-2500f,3333f,-3334f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1666f,3333f,-3334f]
...
data modify storage asa_matrix: Rotate set value [5833f,3333f,-3334f]
...
data modify storage asa_matrix: Rotate set value [-9167f,3333f,-3334f]
