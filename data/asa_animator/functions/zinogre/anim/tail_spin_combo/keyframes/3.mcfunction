data modify storage asa_matrix: Rotate set value [-5000f,0f,10500f]
...
data modify storage asa_matrix: Rotate set value [-4800f,6000f,17000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-6800f,6000f,10500f]
