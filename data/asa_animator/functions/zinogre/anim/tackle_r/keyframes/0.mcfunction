...
data modify storage asa_matrix: Rotate set value [0f,-3125f,625f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-938f,-1250f,-1250f]
...
data modify storage asa_matrix: Rotate set value [0f,625f,-1250f]
...
data modify storage asa_matrix: Rotate set value [2500f,-3125f,-1250f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [3125f,-5000f,-1250f]
...
data modify storage asa_matrix: Rotate set value [-2500f,3750f,-625f]
