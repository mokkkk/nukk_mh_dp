data modify storage asa_matrix: Rotate set value [6000f,-16000f,-4000f]
...
data modify storage asa_matrix: Rotate set value [4000f,-12000f,-4000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2000f,-8000f,-4000f]
...
data modify storage asa_matrix: Rotate set value [0f,8000f,-4000f]
...
data modify storage asa_matrix: Rotate set value [4000f,8000f,4000f]
...
data modify storage asa_matrix: Rotate set value [-8000f,10000f,2000f]
...
data modify storage asa_matrix: Rotate set value [-3000f,-4000f,1000f]
