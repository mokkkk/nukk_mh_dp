data modify storage asa_matrix: Rotate set value [0f,0f,-11000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5000f,0f,-11000f]
...
data modify storage asa_matrix: Rotate set value [20000f,0f,-3000f]
...
data modify storage asa_matrix: Rotate set value [-6000f,4000f,-3000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-12000f,8000f,-3000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2000f,0f,-11000f]
...
data modify storage asa_matrix: Rotate set value [-8000f,0f,-11000f]
...
data modify storage asa_matrix: Rotate set value [-2000f,-24000f,-11000f]
