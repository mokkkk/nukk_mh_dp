data modify storage asa_matrix: Rotate set value [20000f,-2000f,-7000f]
...
data modify storage asa_matrix: Rotate set value [24000f,-6000f,-9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [20000f,-8000f,-9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [16000f,-10000f,-9000f]
...
data modify storage asa_matrix: Rotate set value [-22000f,-4000f,-2000f]
...
data modify storage asa_matrix: Rotate set value [6000f,-20000f,-9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [4000f,-10000f,-21000f]
...
data modify storage asa_matrix: Rotate set value [8400f,-20000f,-9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [8400f,-10000f,-9000f]
