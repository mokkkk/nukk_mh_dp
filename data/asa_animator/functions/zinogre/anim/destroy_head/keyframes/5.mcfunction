data modify storage asa_matrix: Rotate set value [-3334f,-667f,-1334f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-4000f,-667f,-1334f]
...
data modify storage asa_matrix: Rotate set value [-2667f,-667f,-667f]
...
data modify storage asa_matrix: Rotate set value [-667f,1333f,0f]
