data modify storage asa_matrix: Rotate set value [-4200f,-667f,0f]
...
data modify storage asa_matrix: Rotate set value [-534f,-1334f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [800f,-7334f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-7334f,0f]
