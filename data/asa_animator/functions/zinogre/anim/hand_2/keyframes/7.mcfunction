data modify storage asa_matrix: Rotate set value [16000f,2000f,7000f]
...
data modify storage asa_matrix: Rotate set value [-16000f,4000f,2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-14000f,12000f,2000f]
...
data modify storage asa_matrix: Rotate set value [6400f,10000f,9000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [6400f,20000f,9000f]
