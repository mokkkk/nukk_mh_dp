data modify storage asa_matrix: Rotate set value [-1000f,0f,9000f]
...
data modify storage asa_matrix: Rotate set value [-4000f,-6000f,7000f]
...
data modify storage asa_matrix: Rotate set value [-10000f,-8000f,7000f]
