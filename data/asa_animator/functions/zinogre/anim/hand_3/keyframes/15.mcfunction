data modify storage asa_matrix: Rotate set value [-4200f,666f,0f]
...
data modify storage asa_matrix: Rotate set value [-4200f,1333f,0f]
...
data modify storage asa_matrix: Rotate set value [-2867f,2666f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Neck2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-1200f,2666f,0f]
...
data modify storage asa_matrix: Rotate set value [1466f,2666f,0f]
...
data modify storage asa_matrix: Rotate set value [-534f,2666f,0f]
