...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/lightning_claw_r/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/1
execute if entity @s[scores={AsaMatrix=6..14}] run tp @s ^0 ^-0.02222222 ^0
execute if entity @s[scores={AsaMatrix=15}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/2
execute if entity @s[scores={AsaMatrix=15..21}] run tp @s ^0 ^0.08571429 ^0 ~0.5 ~
execute if entity @s[scores={AsaMatrix=22}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/3
execute if entity @s[scores={AsaMatrix=22..32}] run tp @s ^0 ^0.009090909 ^0 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=33}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/4
execute if entity @s[scores={AsaMatrix=33..37}] run tp @s ^0 ^-0.04 ^0
execute if entity @s[scores={AsaMatrix=38}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/5
execute if entity @s[scores={AsaMatrix=38..42}] run tp @s ^0 ^-0.04 ^0
execute if entity @s[scores={AsaMatrix=43}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/6
execute if entity @s[scores={AsaMatrix=43..55}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=56}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/7
execute if entity @s[scores={AsaMatrix=56..60}] run tp @s ^-0.4 ^0.42 ^0
execute if entity @s[scores={AsaMatrix=61}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/8
execute if entity @s[scores={AsaMatrix=61..64}] run tp @s ^0.25 ^1.5 ^-0.375 ~-19 ~
execute if entity @s[scores={AsaMatrix=65}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/9
execute if entity @s[scores={AsaMatrix=65..69}] run tp @s ^0.05 ^0.025 ^-0.1125 ~-19 ~
execute if entity @s[scores={AsaMatrix=70}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/10
execute if entity @s[scores={AsaMatrix=70..76}] run tp @s ^0.03571429 ^-0.6107143 ^-0.08035714 ~-18 ~
execute if entity @s[scores={AsaMatrix=77}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/11
execute if entity @s[scores={AsaMatrix=77..87}] run tp @s ^0.04545455 ^-0.3772728 ^-0.4 ~-3 ~
execute if entity @s[scores={AsaMatrix=88}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/12
execute if entity @s[scores={AsaMatrix=88..102}] run tp @s ^0 ^0 ^-0.1 ~-0.5 ~
execute if entity @s[scores={AsaMatrix=103}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/13
execute if entity @s[scores={AsaMatrix=103..117}] run tp @s ^0 ^0.003333333 ^0.008333334
execute if entity @s[scores={AsaMatrix=118}] run function asa_animator:zinogre/anim/lightning_claw_r/keyframes/14
execute if entity @s[scores={AsaMatrix=118..132}] run tp @s ^0 ^0.003333333 ^0.008333334
execute if entity @s[scores={AsaMatrix=133..}] run function asa_animator:zinogre/anim/lightning_claw_r/end
