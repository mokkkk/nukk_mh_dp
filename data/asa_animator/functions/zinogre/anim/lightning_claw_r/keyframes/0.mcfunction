...
data modify storage asa_matrix: Rotate set value [-1000f,6000f,500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [5000f,6000f,1500f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmR0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3000f,6000f,1500f]
...
data modify storage asa_matrix: Rotate set value [4000f,6000f,-500f]
