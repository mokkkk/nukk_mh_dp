data modify storage asa_matrix: Rotate set value [0f,-3572f,-4286f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-715f,-3572f,-4286f]
...
data modify storage asa_matrix: Rotate set value [0f,-358f,0f]
...
data modify storage asa_matrix: Rotate set value [0f,-3215f,0f]
