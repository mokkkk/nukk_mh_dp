...
data modify storage asa_matrix: Rotate set value [-2000f,1500f,-1000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegL1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [2750f,2000f,-2000f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=LegR1] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-2500f,3000f,-500f]
...
data modify storage asa_matrix: Rotate set value [1500f,3500f,-1500f]
...
data modify storage asa_matrix: Rotate set value [150f,1100f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=ArmL2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [1000f,100f,0f]
