...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ZinogreParts,distance=..4.5] run function asa_animator:zinogre/anim/jump/events/damage_sub
