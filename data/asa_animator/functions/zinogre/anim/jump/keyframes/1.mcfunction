...
data modify storage asa_matrix: Rotate set value [625f,416f,0f]
...
data modify storage asa_matrix: Rotate set value [625f,-417f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail2] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-209f,-834f,0f]
...
data modify storage asa_matrix: Rotate set value [41f,41f,0f]
