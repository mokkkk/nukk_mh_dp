data modify storage asa_matrix: Rotate set value [-589f,0f,0f]
...
data modify storage asa_matrix: Rotate set value [-295f,294f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=Tail0] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [0f,294f,0f]
...
data modify storage asa_matrix: Rotate set value [-589f,-295f,0f]
