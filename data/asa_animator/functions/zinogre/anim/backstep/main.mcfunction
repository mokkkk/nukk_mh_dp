...
execute if score #asa_zinogre_tick_current AsaMatrix >= #asa_zinogre_tick_end AsaMatrix run function asa_animator:zinogre/anim/backstep/keyframes/manager
function asa_animator:zinogre/anim/backstep/events/manager
