data modify storage asa_matrix: Rotate set value [-6500f,34500f,0f]
execute as @e[type=armor_stand,tag=ZinogreParts,tag=HeadU] run function #asa_matrix:animate_setparam
data modify storage asa_matrix: Rotate set value [-3500f,34500f,0f]
...
data modify storage asa_matrix: Rotate set value [-1500f,34500f,0f]
