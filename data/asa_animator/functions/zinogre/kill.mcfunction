...
scoreboard players reset #mhdp_zinogre_kill_timer
scoreboard players reset #mhdp_zinogre_charge_count
scoreboard players reset #mhdp_zinogre_dash_count
scoreboard players reset #mhdp_zinogre_hand_count
scoreboard players reset #mhdp_zinogre_actcount
scoreboard players reset #mhdp_zinogre_actcount_charge
scoreboard players reset #mhdp_zinogre_actcount_thunder
...
scoreboard players reset #mhdp_zinogre_charge_damage
scoreboard players reset #mhdp_zinogre_charge_damage_max
...
scoreboard players reset #mhdp_zinogre_combo_count
...
scoreboard players reset #mhdp_zinogre_flash_time_current