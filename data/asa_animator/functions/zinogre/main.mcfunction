...
# function asa_animator:zinogre/anim/test/main
...
# 飛行待機
# execute if predicate asa_animator:zinogre/stay if entity @s[tag=IsFlying] run function asa_animator:zinogre/anim/flying_stay/main
# 軸合わせ
