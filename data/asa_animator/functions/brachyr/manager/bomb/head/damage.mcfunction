...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!BrachyRParts,distance=0..4.5] run function asa_animator:brachyr/manager/bomb/damage_sub
