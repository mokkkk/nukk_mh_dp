...
execute if entity @s[tag=Phase2] if score #mhdp_brachyr_act_count AsaMatrix matches 1.. if predicate asa_animator:random/020 run function asa_animator:brachyr/manager/change_normal/phase2/change
