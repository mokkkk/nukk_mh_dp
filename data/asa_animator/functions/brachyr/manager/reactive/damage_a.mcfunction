...
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyRParts,distance=..4] run function asa_animator:brachyr/manager/reactive/damage_sub
 data modify storage score_damage: Argument set value {Damage:8.0f, BypassArmor:0b}
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyRParts,distance=4..5] run function asa_animator:brachyr/manager/reactive/damage_sub
