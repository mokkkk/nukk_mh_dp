...
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyParts,distance=..4] run function asa_animator:brachyr/manager/reactive/damage_sub
data merge storage score_damage: {Damage:8.0f, BypassArmor:0b}
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyParts,distance=4..5] run function asa_animator:brachyr/manager/reactive/damage_sub
