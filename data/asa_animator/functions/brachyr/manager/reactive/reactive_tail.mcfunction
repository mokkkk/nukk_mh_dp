...
execute at @e[type=armor_stand,tag=BrachyRParts,tag=Tail3,distance=0..15] positioned ~ ~1.4 ~ facing entity @e[tag=BrachyRTarget,sort=nearest,limit=1] feet positioned ^ ^ ^0.5 run function asa_animator:brachyr/manager/reactive/damage_a
