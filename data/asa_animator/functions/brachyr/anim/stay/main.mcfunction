...
execute if score @s AsaMatrix matches 1 run function asa_animator:brachyr/anim/stay/start
execute if score @s AsaMatrix matches 1 run function asa_animator:brachyr/anim/stay/keyframes/0
execute if score @s AsaMatrix matches 1..5 run tp @s ^0 ^-0.01 ^0.02
execute if score @s AsaMatrix matches 6 run function asa_animator:brachyr/anim/stay/keyframes/1
execute if score @s AsaMatrix matches 6..15 run tp @s ^0 ^0.015 ^-0.01
execute if score @s AsaMatrix matches 16 run function asa_animator:brachyr/anim/stay/keyframes/2
execute if score @s AsaMatrix matches 16..20 run tp @s ^0 ^-0.04 ^0.02
execute if score @s AsaMatrix matches 21 run function asa_animator:brachyr/anim/stay/keyframes/3
execute if score @s AsaMatrix matches 21..35 run tp @s ^0 ^0.003333333 ^0.01
execute if score @s AsaMatrix matches 36 run function asa_animator:brachyr/anim/stay/keyframes/4
