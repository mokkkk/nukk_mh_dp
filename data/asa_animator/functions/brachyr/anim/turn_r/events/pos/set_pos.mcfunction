...
# 地上にmarkerセット
summon marker ^-12 ^ ^12 {Tags:["BrachyRMovePos"]}
execute facing entity @e[tag=BrachyRAttackTarget,limit=1] eyes rotated ~ 0 run tp @e[type=marker,tag=BrachyRMovePos] ^-12 ^ ^12
# execute facing entity @e[tag=BrachyRAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=BrachyRAttackTarget] positioned as @s run tp @e[type=marker,tag=BrachyRMovePos] ^7 ^ ^
...
execute as @e[type=marker,tag=BrachyRMovePos,limit=1] at @s run tp @s ~ ~0.5 ~
...
scoreboard players set #brachyr_height_target AsaMatrix 15
scoreboard players operation #brachyr_mine_x AsaMatrix /= #brachyr_height_target AsaMatrix
scoreboard players operation #brachyr_mine_y AsaMatrix /= #brachyr_height_target AsaMatrix
scoreboard players operation #brachyr_mine_z AsaMatrix /= #brachyr_height_target AsaMatrix
