...
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyParts,distance=..3] run function asa_animator:brachy/manager/bomb/damage_sub
data merge storage score_damage: {Damage:5.0f, BypassArmor:0b}
execute as @e[type=!armor_stand,type=!marker,tag=!BrachyParts,distance=3..5] run function asa_animator:brachy/manager/bomb/damage_sub
