...
execute as @a[distance=..6.7] run function mh_dp:player/knockback/start_wind
...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!BrachyRParts,distance=4..6.7] run function asa_animator:brachyr/manager/bomb/damage_sub
