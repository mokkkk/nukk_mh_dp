...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!BrachyParts,distance=0..4] run function asa_animator:brachy/manager/bomb/damage_sub
