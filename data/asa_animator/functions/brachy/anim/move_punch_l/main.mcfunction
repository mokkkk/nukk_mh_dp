...
execute if score @s AsaMatrix matches 1 run function asa_animator:brachy/anim/move_punch_l/start
execute if score @s AsaMatrix matches 1 run function asa_animator:brachy/anim/move_punch_l/keyframes/0
execute if score @s AsaMatrix matches 1..5 run tp @s ^0 ^0 ^0
execute if score @s AsaMatrix matches 6 run function asa_animator:brachy/anim/move_punch_l/keyframes/1
execute if score @s AsaMatrix matches 6..10 run tp @s ^0 ^0.02 ^0
execute if score @s AsaMatrix matches 11 run function asa_animator:brachy/anim/move_punch_l/keyframes/2
