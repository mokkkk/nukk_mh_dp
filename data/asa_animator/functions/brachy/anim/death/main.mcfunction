...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:brachy/anim/death/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:brachy/anim/death/keyframes/0
execute if entity @s[scores={AsaMatrix=1..8}] run tp @s ^0 ^0.0125 ^-0.0125
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:brachy/anim/death/keyframes/1
execute if entity @s[scores={AsaMatrix=9..16}] run tp @s ^0 ^-0.225 ^0.0625
execute if entity @s[scores={AsaMatrix=17}] run function asa_animator:brachy/anim/death/keyframes/2
execute if entity @s[scores={AsaMatrix=17..25}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=26}] run function asa_animator:brachy/anim/death/keyframes/3
execute if entity @s[scores={AsaMatrix=26..40}] run tp @s ^0 ^0.08000001 ^-0.01333333
execute if entity @s[scores={AsaMatrix=41}] run function asa_animator:brachy/anim/death/keyframes/4
execute if entity @s[scores={AsaMatrix=41..45}] run tp @s ^0 ^0 ^
execute if entity @s[scores={AsaMatrix=46}] run function asa_animator:brachy/anim/death/keyframes/5
execute if entity @s[scores={AsaMatrix=46..60}] run tp @s ^0 ^0.006666666 ^-0.006666666
execute if entity @s[scores={AsaMatrix=61}] run function asa_animator:brachy/anim/death/keyframes/6
execute if entity @s[scores={AsaMatrix=61..75}] run tp @s ^0 ^0 ^
execute if entity @s[scores={AsaMatrix=76}] run function asa_animator:brachy/anim/death/keyframes/7
execute if entity @s[scores={AsaMatrix=76..84}] run tp @s ^0 ^-0.1444445 ^0.03333334
execute if entity @s[scores={AsaMatrix=85}] run function asa_animator:brachy/anim/death/keyframes/8
execute if entity @s[scores={AsaMatrix=85..100}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=101..}] run function asa_animator:brachy/anim/death/end
