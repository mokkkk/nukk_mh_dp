...
execute if score @s AsaMatrix matches 1 run function asa_animator:brachy/anim/turn_r/start
execute if score @s AsaMatrix matches 1 run function asa_animator:brachy/anim/turn_r/keyframes/0
execute if score @s AsaMatrix matches 1..4 run tp @s ^0 ^0.0375 ^0
execute if score @s AsaMatrix matches 5 run function asa_animator:brachy/anim/turn_r/keyframes/1
execute if score @s AsaMatrix matches 5..8 run tp @s ^0 ^-0.05 ^0
execute if score @s AsaMatrix matches 9 run function asa_animator:brachy/anim/turn_r/keyframes/2
execute if score @s AsaMatrix matches 9..13 run tp @s ^0 ^0.2 ^0
execute if score @s AsaMatrix matches 14 run function asa_animator:brachy/anim/turn_r/keyframes/3
execute if score @s AsaMatrix matches 14..20 run tp @s ^0 ^-0.1642857 ^0
execute if score @s AsaMatrix matches 21 run function asa_animator:brachy/anim/turn_r/keyframes/4
execute if score @s AsaMatrix matches 21..25 run tp @s ^-0.2 ^0.04 ^0
execute if score @s AsaMatrix matches 26.. run function asa_animator:brachy/anim/turn_r/end
...
execute if score @s AsaMatrix matches 5 run function asa_animator:brachy/anim/turn_r/events/pos/set_pos
