...
# 近距離
execute if predicate asa_animator:teo/stay if entity @e[tag=TeoAttackTarget,distance=..15] run function asa_animator:teo/manager/change_normal/f/range_near
# 中距離
