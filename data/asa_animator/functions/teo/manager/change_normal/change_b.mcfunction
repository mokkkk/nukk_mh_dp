...
# 近距離
execute if predicate asa_animator:teo/stay if entity @e[tag=TeoAttackTarget,distance=..13] run function asa_animator:teo/manager/change_normal/b/range_near
# 中距離
