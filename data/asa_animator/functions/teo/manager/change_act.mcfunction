...
# 状態変化・大技
execute if predicate asa_animator:teo/stay if predicate asa_animator:teo/combo if score #mhdp_teo_actcount_lv AsaMatrix matches 16.. if score #mhdp_teo_lv AsaMatrix matches ..0 run tag @s add AnmCharge
execute if predicate asa_animator:teo/stay if predicate asa_animator:teo/combo if score #mhdp_teo_actcount_lv AsaMatrix matches 36.. if score #mhdp_teo_lv AsaMatrix matches 1 run tag @s add AnmCharge
execute if predicate asa_animator:teo/stay if predicate asa_animator:teo/combo if score #mhdp_teo_actcount_lv AsaMatrix matches 70.. if score #mhdp_teo_lv AsaMatrix matches 2.. run tag @s add AnmSupernova
