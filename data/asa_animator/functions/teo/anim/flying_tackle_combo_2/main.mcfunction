...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:teo/anim/flying_tackle_combo_2/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:teo/anim/flying_tackle_combo_2/keyframes/0
...
execute if entity @s[scores={AsaMatrix=56..}] at @s rotated as @e[type=marker,tag=TeoMoveRotate] run tp @s ^ ^ ^0.1
