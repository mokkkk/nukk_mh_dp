...
# 粉塵纏い
    ...
    execute if entity @s[scores={AsaMatrix=45}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b
    execute if entity @s[scores={AsaMatrix=50}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b
    execute if entity @s[scores={AsaMatrix=55}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b
    execute if entity @s[scores={AsaMatrix=70}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b
    execute if entity @s[scores={AsaMatrix=77}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b
    execute if entity @s[scores={AsaMatrix=80}] positioned as @e[type=armor_stand,tag=TeoParts,tag=HeadU] positioned ^ ^1.2 ^1 rotated as @e[type=marker,tag=TeoMoveRotate,distance=0..8] positioned ^ ^ ^6 run function asa_animator:teo/anim/bomb_large/events/damage_b