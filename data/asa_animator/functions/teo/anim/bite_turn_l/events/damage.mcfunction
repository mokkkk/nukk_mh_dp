...
execute if entity @s[tag=IsBomb] if score #mhdp_teo_lv AsaMatrix matches 1.. as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!TeoParts,distance=..5] run function asa_animator:teo/anim/bite_turn_l/events/damage_sub
