...
execute positioned ^ ^ ^ if block ~ ~ ~ #asa_animator:no_collision run function asa_animator:teo/anim/flying_breath/events/damage_f_
scoreboard players reset #mhdp_teo_temp

execute as @e[tag=MhdpHit] run function asa_animator:teo/anim/flying_breath/events/damage_f_sub
