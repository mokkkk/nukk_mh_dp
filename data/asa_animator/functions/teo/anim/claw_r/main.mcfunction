...
execute if entity @s[scores={AsaMatrix=38}] run function asa_animator:teo/anim/claw_r/keyframes/6
execute if entity @s[scores={AsaMatrix=38..55}] run tp @s ^0 ^0.005555556 ^-0.01111111
execute if entity @s[scores={AsaMatrix=56..}] run function asa_animator:teo/anim/claw_r/end
