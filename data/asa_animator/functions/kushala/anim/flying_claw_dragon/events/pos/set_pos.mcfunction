...
# 地上にmarkerセット
summon marker ^ ^ ^3 {Tags:["KushalaMovePos"]}
execute if entity @e[tag=KushalaAttackTarget,distance=0..18] facing entity @e[tag=KushalaAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=KushalaAttackTarget] positioned as @s run tp @e[type=marker,tag=KushalaMovePos] ^ ^ ^-4.5
...
execute as @e[type=marker,tag=KushalaMovePos,limit=1] at @s run tp @s ~ ~-0.1 ~
...
scoreboard players set #kushala_height_target AsaMatrix 6
scoreboard players operation #kushala_mine_x AsaMatrix /= #kushala_height_target AsaMatrix
scoreboard players operation #kushala_mine_y AsaMatrix /= #kushala_height_target AsaMatrix
scoreboard players operation #kushala_mine_z AsaMatrix /= #kushala_height_target AsaMatrix
