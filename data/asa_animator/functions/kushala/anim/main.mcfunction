...
## その他
    ...
    # 怒り
    execute if entity @s[tag=AnmAnger] run function asa_animator:kushala/anim/anger/main
    # 飛行中怒り
    execute if entity @s[tag=AnmFlyAnger] run function asa_animator:kushala/anim/flying_anger/main