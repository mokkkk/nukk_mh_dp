...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/dash_stop/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/dash_stop/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^0.3
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:kushala/anim/dash_stop/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^0 ^0.2
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:kushala/anim/dash_stop/keyframes/2
execute if entity @s[scores={AsaMatrix=11..22}] run tp @s ^0 ^0 ^0.08
execute if entity @s[scores={AsaMatrix=23..}] run function asa_animator:kushala/anim/dash_stop/end
