...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/claw_dragon/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/claw_dragon/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^-0.02 ^0.04
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:kushala/anim/claw_dragon/keyframes/1
execute if entity @s[scores={AsaMatrix=6}] run tp @s ^0 ^0 ^-0.1
execute if entity @s[scores={AsaMatrix=7}] run function asa_animator:kushala/anim/claw_dragon/keyframes/2
execute if entity @s[scores={AsaMatrix=7..13}] run tp @s ^0 ^0.5714286 ^-0.1428571
execute if entity @s[scores={AsaMatrix=14}] run function asa_animator:kushala/anim/claw_dragon/keyframes/3
execute if entity @s[scores={AsaMatrix=14..23}] run tp @s ^0 ^0.00999999 ^-0.04
execute if entity @s[scores={AsaMatrix=24}] run function asa_animator:kushala/anim/claw_dragon/keyframes/4
execute if entity @s[scores={AsaMatrix=24..29}] run tp @s ^0 ^ ^
execute if entity @s[scores={AsaMatrix=30}] run function asa_animator:kushala/anim/claw_dragon/keyframes/5
execute if entity @s[scores={AsaMatrix=30..45}] run tp @s ^0 ^-0.00625 ^0
execute if entity @s[scores={AsaMatrix=46}] run function asa_animator:kushala/anim/claw_dragon/keyframes/6
execute if entity @s[scores={AsaMatrix=46..52}] run tp @s ^0 ^0.007142857 ^0
execute if entity @s[scores={AsaMatrix=53}] run function asa_animator:kushala/anim/claw_dragon/keyframes/7
execute if entity @s[scores={AsaMatrix=53..60}] run tp @s ^0 ^0.00625 ^0 ~0.5 ~
execute if entity @s[scores={AsaMatrix=61..}] run function asa_animator:kushala/anim/claw_dragon/end
...
execute if entity @s[scores={AsaMatrix=37}] if score #mhdp_kushala_lv AsaMatrix matches 2 run function asa_animator:kushala/anim/claw_dragon/events/change