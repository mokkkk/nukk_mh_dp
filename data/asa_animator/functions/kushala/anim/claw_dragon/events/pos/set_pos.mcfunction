...
execute facing entity @e[tag=KushalaAttackTarget,limit=1] eyes rotated ~ 0 as @e[tag=KushalaAttackTarget] positioned as @s run tp @e[type=marker,tag=KushalaMovePos] ^ ^ ^-4.5
