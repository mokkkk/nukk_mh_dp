...
execute as @e[type=armor_stand,tag=KushalaParts,tag=LegL1] run data merge entity @s {Pose:{Head:[-28f,0f,10f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=LegR1] run data merge entity @s {Pose:{Head:[2f,0f,-10f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=LegL2] run data merge entity @s {Pose:{Head:[42f,-10f,0f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=LegR2] run data merge entity @s {Pose:{Head:[32f,0f,0f]}}
...
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmL0] run data merge entity @s {Pose:{Head:[-28f,0f,-30f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmR0] run data merge entity @s {Pose:{Head:[-28f,-30f,20f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmL1] run data merge entity @s {Pose:{Head:[-34f,-10f,10f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmR1] run data merge entity @s {Pose:{Head:[-32f,0f,0f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmL2] run data merge entity @s {Pose:{Head:[51f,-10f,-10f]}}
execute as @e[type=armor_stand,tag=KushalaParts,tag=ArmR2] run data merge entity @s {Pose:{Head:[43f,0f,10f]}}
