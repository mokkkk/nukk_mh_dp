...
execute if entity @e[type=!armor_stand,type=!marker,tag=!KushalaParts,distance=0..3] positioned ~ ~1.4 ~ run function asa_animator:kushala/anim/bjb_land/events/damage
