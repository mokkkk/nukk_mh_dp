...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/flying_damage/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/flying_damage/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0.08 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:kushala/anim/flying_damage/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^0.2 ^0
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:kushala/anim/flying_damage/keyframes/2
execute if entity @s[scores={AsaMatrix=11..16}] run tp @s ^ ^ ^
execute if entity @s[scores={AsaMatrix=17}] run function asa_animator:kushala/anim/flying_damage/keyframes/3
execute if entity @s[scores={AsaMatrix=17..22}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=23}] run function asa_animator:kushala/anim/flying_damage/keyframes/4
execute if entity @s[scores={AsaMatrix=23..40}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=41}] run function asa_animator:kushala/anim/flying_damage/keyframes/5
execute if entity @s[scores={AsaMatrix=41..51}] run tp @s ^0 ^0.07272727 ^-0.009090909
execute if entity @s[scores={AsaMatrix=52}] run function asa_animator:kushala/anim/flying_damage/keyframes/6
execute if entity @s[scores={AsaMatrix=52..62}] run tp @s ^0 ^0.03636364 ^-0.009090909
execute if entity @s[scores={AsaMatrix=63}] run function asa_animator:kushala/anim/flying_damage/keyframes/7
execute if entity @s[scores={AsaMatrix=63..74}] run tp @s ^0 ^0.01666667 ^0
execute if entity @s[scores={AsaMatrix=75..}] run function asa_animator:kushala/anim/flying_damage/end
