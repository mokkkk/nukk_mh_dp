...
execute if entity @s[scores={AsaMatrix=19..}] run function asa_animator:kushala/anim/move/end
...
# 停止
execute if entity @e[tag=KushalaAttackTarget,distance=0..8] run function asa_animator:kushala/anim/move/events/change