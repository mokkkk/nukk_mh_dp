...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/start_fly_turn_l/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/start_fly_turn_l/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:kushala/anim/start_fly_turn_l/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^0.44 ^0
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:kushala/anim/start_fly_turn_l/keyframes/2
execute if entity @s[scores={AsaMatrix=11..18}] run tp @s ^0 ^-0.075 ^0
execute if entity @s[scores={AsaMatrix=19}] run function asa_animator:kushala/anim/start_fly_turn_l/keyframes/3
execute if entity @s[scores={AsaMatrix=19..26}] run tp @s ^0 ^0.4375 ^0
execute if entity @s[scores={AsaMatrix=27}] run function asa_animator:kushala/anim/start_fly_turn_l/keyframes/4
execute if entity @s[scores={AsaMatrix=27..38}] run tp @s ^0 ^-0.2 ^-0.01666667
execute if entity @s[scores={AsaMatrix=39..}] run function asa_animator:kushala/anim/start_fly_turn_l/end
