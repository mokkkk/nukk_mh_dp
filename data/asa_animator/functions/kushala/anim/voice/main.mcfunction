...
execute if entity @s[scores={AsaMatrix=16..50}] run playsound minecraft:entity.wither.ambient master @a ~ ~ ~ 3 1.5
execute if entity @s[scores={AsaMatrix=12..16}] run playsound entity.ender_dragon.growl master @a ~ ~ ~ 3 0.7
