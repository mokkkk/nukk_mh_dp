...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/step_r/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:kushala/anim/step_r/keyframes/0
execute if entity @s[scores={AsaMatrix=1..5}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=6}] run function asa_animator:kushala/anim/step_r/keyframes/1
execute if entity @s[scores={AsaMatrix=6..10}] run tp @s ^0 ^0.44 ^0 ~-2 ~
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:kushala/anim/step_r/keyframes/2
execute if entity @s[scores={AsaMatrix=11..17}] run tp @s ^0 ^-0.3142857 ^0 ~-2 ~
execute if entity @s[scores={AsaMatrix=18}] run function asa_animator:kushala/anim/step_r/keyframes/3
execute if entity @s[scores={AsaMatrix=18..24}] run tp @s ^-0.05714286 ^0 ^0 ~2 ~
execute if entity @s[scores={AsaMatrix=25..}] run function asa_animator:kushala/anim/step_r/end
