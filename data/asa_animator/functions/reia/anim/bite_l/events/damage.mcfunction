...
execute as @e[distance=0..3.5,type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ReiaParts] run function asa_animator:reia/anim/bite_l/events/damage_sub
