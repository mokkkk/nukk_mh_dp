...
execute unless entity @s[tag=DestroyHead] if entity @s[scores={AsaMatrix=21}] run data modify entity @e[type=armor_stand,tag=ReiaParts,tag=HeadU,limit=1] ArmorItems[3].tag.CustomModelData set value 10118
execute if entity @s[tag=DestroyHead] if entity @s[scores={AsaMatrix=21}] run data modify entity @e[type=armor_stand,tag=ReiaParts,tag=HeadU,limit=1] ArmorItems[3].tag.CustomModelData set value 10157
