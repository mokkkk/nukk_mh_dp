...
execute if score @s AsaMatrix matches 1 run function asa_animator:reia/anim/death/start
execute if score @s AsaMatrix matches 1 run function asa_animator:reia/anim/death/keyframes/0
execute if score @s AsaMatrix matches 1..15 run tp @s ^0 ^-0.01333333 ^0.01333333 ~-1 ~
execute if score @s AsaMatrix matches 16 run function asa_animator:reia/anim/death/keyframes/1
execute if score @s AsaMatrix matches 16..20 run tp @s ^0 ^0 ^0
execute if score @s AsaMatrix matches 21 run function asa_animator:reia/anim/death/keyframes/2
execute if score @s AsaMatrix matches 21..35 run tp @s ^0 ^0.01333333 ^-0.01333333
execute if score @s AsaMatrix matches 36 run function asa_animator:reia/anim/death/keyframes/3
execute if score @s AsaMatrix matches 36..40 run tp @s ^0 ^0 ^0
execute if score @s AsaMatrix matches 41 run function asa_animator:reia/anim/death/keyframes/4
execute if score @s AsaMatrix matches 41..50 run tp @s ^-0.04 ^0 ^0
execute if score @s AsaMatrix matches 51 run function asa_animator:reia/anim/death/keyframes/5
execute if score @s AsaMatrix matches 51..55 run tp @s ^-0.02 ^0 ^0
execute if score @s AsaMatrix matches 56 run function asa_animator:reia/anim/death/keyframes/6
execute if score @s AsaMatrix matches 56..65 run tp @s ^-0.15 ^-0.1 ^0
execute if score @s AsaMatrix matches 66 run function asa_animator:reia/anim/death/keyframes/7
execute if score @s AsaMatrix matches 66..80 run tp @s ^0 ^0 ^0
execute if score @s AsaMatrix matches 81.. run function asa_animator:reia/anim/death/end
