...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:reia/anim/tail_spin_r/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:reia/anim/tail_spin_r/keyframes/0
execute if entity @s[scores={AsaMatrix=1..8}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=9}] run function asa_animator:reia/anim/tail_spin_r/keyframes/1
execute if entity @s[scores={AsaMatrix=9..18}] run tp @s ^0 ^0 ^0
execute if entity @s[scores={AsaMatrix=19}] run function asa_animator:reia/anim/tail_spin_r/keyframes/2
execute if entity @s[scores={AsaMatrix=19..23}] run tp @s ^0 ^-0.02 ^0 ~-20 ~
execute if entity @s[scores={AsaMatrix=24}] run function asa_animator:reia/anim/tail_spin_r/keyframes/3
...
execute if entity @s[scores={AsaMatrix=33}] run function asa_animator:reia/anim/tail_spin_r/keyframes/4
execute if entity @s[scores={AsaMatrix=33..42}] run tp @s ^0 ^0.02 ^0
execute if entity @s[scores={AsaMatrix=43..}] run function asa_animator:reia/anim/tail_spin_r/end
