...
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:reia/anim/voice/start
execute if entity @s[scores={AsaMatrix=1}] run function asa_animator:reia/anim/voice/keyframes/0
execute if entity @s[scores={AsaMatrix=1..10}] run tp @s ^0 ^0.01 ^0
execute if entity @s[scores={AsaMatrix=11}] run function asa_animator:reia/anim/voice/keyframes/1
execute if entity @s[scores={AsaMatrix=11..20}] run tp @s ^0 ^-0.01 ^-0.03
execute if entity @s[scores={AsaMatrix=21}] run function asa_animator:reia/anim/voice/keyframes/2
execute if entity @s[scores={AsaMatrix=21..27}] run tp @s ^0 ^0.01428571 ^-0.05714285
execute if entity @s[scores={AsaMatrix=28}] run function asa_animator:reia/anim/voice/keyframes/3
execute if entity @s[scores={AsaMatrix=28..50}] run tp @s ^0 ^0.004347826 ^0.02608696
execute if entity @s[scores={AsaMatrix=51}] run function asa_animator:reia/anim/voice/keyframes/4
execute if entity @s[scores={AsaMatrix=51..60}] run tp @s ^0 ^-0.04 ^0.01
execute if entity @s[scores={AsaMatrix=61}] run function asa_animator:reia/anim/voice/keyframes/5
execute if entity @s[scores={AsaMatrix=61..70}] run tp @s ^0 ^0.02 ^0
execute if entity @s[scores={AsaMatrix=71..}] run function asa_animator:reia/anim/voice/end
execute as @e[type=armor_stand,tag=ReiaParts] run function #asa_matrix:animate
function asa_animator:reia/model

execute if entity @s[scores={AsaMatrix=1}] unless entity @e[tag=ReiaAttackTarget] as @p run tag @s add ReiaAttackTarget
