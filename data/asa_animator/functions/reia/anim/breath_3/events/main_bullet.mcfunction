...
execute if entity @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ReiaParts,distance=0..3] positioned ~ ~1.4 ~ run function asa_animator:reia/anim/breath_3/events/damage
