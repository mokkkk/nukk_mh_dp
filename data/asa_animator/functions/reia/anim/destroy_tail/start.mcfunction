execute as @e[type=armor_stand,tag=ReiaParts,tag=HeadU] run data merge entity @s {Pose:{Head:[-15f,0f,0f]}}
...
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingL0] run data merge entity @s {Pose:{Head:[65f,0f,-10f]}}
