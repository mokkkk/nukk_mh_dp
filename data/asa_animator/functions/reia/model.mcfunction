...
execute as @e[type=armor_stand,tag=ReiaParts,tag=Body1,limit=1] rotated ~ 0 run tp @s ^0 ^1.35 ^0 ~ ~
...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix -151
...
scoreboard players set #asa_child_pos_x AsaMatrix 0
scoreboard players set #asa_child_pos_y AsaMatrix 100
scoreboard players set #asa_child_pos_z AsaMatrix 399
function #asa_matrix:rotate
...
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingL1,limit=1] at @s run function #asa_matrix:get_parent_pos
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingL1,limit=1] run function #asa_matrix:matrix_node
scoreboard players set #asa_child_pos_x AsaMatrix 800
scoreboard players set #asa_child_pos_y AsaMatrix 1600
scoreboard players set #asa_child_pos_z AsaMatrix 0
function #asa_matrix:rotate
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingL2,limit=1] run function #asa_matrix:set_child_pos
...
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingR1,limit=1] at @s run function #asa_matrix:get_parent_pos
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingR1,limit=1] run function #asa_matrix:matrix_node
scoreboard players set #asa_child_pos_x AsaMatrix -800
scoreboard players set #asa_child_pos_y AsaMatrix 1600
scoreboard players set #asa_child_pos_z AsaMatrix 0
function #asa_matrix:rotate
execute as @e[type=armor_stand,tag=ReiaParts,tag=WingR2,limit=1] run function #asa_matrix:set_child_pos
