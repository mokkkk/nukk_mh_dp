...
execute as @e[distance=0..6,type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ReusParts] run function asa_animator:reus/anim/bite_charge/events/damage_sub
