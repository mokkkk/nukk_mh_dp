...
execute as @e[type=armor_stand,tag=ReusParts,tag=LegL0] run data merge entity @s {Pose:{Head:[-30f,0f,0f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=LegR0] run data merge entity @s {Pose:{Head:[-30f,0f,0f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=LegL1] run data merge entity @s {Pose:{Head:[30f,0f,0f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=LegR1] run data merge entity @s {Pose:{Head:[30f,0f,0f]}}
