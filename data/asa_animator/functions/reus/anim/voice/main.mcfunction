...
execute if entity @s[scores={AsaMatrix=27..50}] at @e[distance=0..20,type=armor_stand,tag=ReusParts,tag=HeadU] positioned ^ ^1.1 ^0.7 run particle flash ~ ~ ~ 0 0 0 0 1
