...
execute if entity @s[scores={AsaMatrix=22}] as @a[distance=..48] run playsound entity.ender_dragon.growl master @a ~ ~ ~ 1 0.5 1
execute if entity @s[scores={AsaMatrix=27..55}] as @a[distance=..48] run playsound entity.ravager.attack master @a ~ ~ ~ 0.7 0.7 0.7
