...
execute if entity @s[scores={AsaMatrix=71..}] run function asa_animator:reus/anim/voice/end
...
execute if entity @s[scores={AsaMatrix=29..50}] at @e[distance=0..20,type=armor_stand,tag=ReusParts,tag=HeadU] positioned ^ ^1.1 ^0.7 run particle flash ~ ~ ~ 0 0 0 0 1
execute if entity @s[scores={AsaMatrix=29..50}] positioned ^ ^ ^6 run particle block grass_block ~ ~ ~ 2 0.1 2 0 5