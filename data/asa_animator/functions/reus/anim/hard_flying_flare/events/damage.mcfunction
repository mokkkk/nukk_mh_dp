...
execute as @e[type=!armor_stand,type=!area_effect_cloud,type=!marker,tag=!ReusParts,distance=0..4.5] run function asa_animator:reus/anim/flying_breath_large/events/damage_sub
