...
execute if score @s AsaMatrix matches 1.. if block ~ ~ ~ #asa_animator:no_collision positioned ^ ^ ^1 run function asa_animator:reus/normal/flying_charge/effect/attack_tp
