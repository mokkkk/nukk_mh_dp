...
execute as @e[type=armor_stand,tag=ReusParts,tag=WingL0] run data merge entity @s {Pose:{Head:[70f,0f,20f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=WingR0] run data merge entity @s {Pose:{Head:[70f,0f,-20f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=WingL1] run data merge entity @s {Pose:{Head:[70f,0f,20f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=WingR1] run data merge entity @s {Pose:{Head:[70f,0f,-20f]}}
