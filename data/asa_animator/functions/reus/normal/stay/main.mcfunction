...
execute if score @s AsaMatrix matches 1 run function asa_animator:reus/normal/stay/start
execute if score @s AsaMatrix matches 1 run function asa_animator:reus/normal/stay/keyframes/0
execute if score @s AsaMatrix matches 1..20 run tp @s ^0 ^-0.005 ^0.005
execute if score @s AsaMatrix matches 21 run function asa_animator:reus/normal/stay/keyframes/1
execute if score @s AsaMatrix matches 21..40 run tp @s ^0 ^-0.005 ^0.005
execute if score @s AsaMatrix matches 41 run function asa_animator:reus/normal/stay/keyframes/2
execute if score @s AsaMatrix matches 41..60 run tp @s ^0 ^0.005 ^-0.005
execute if score @s AsaMatrix matches 61 run function asa_animator:reus/normal/stay/keyframes/3
execute if score @s AsaMatrix matches 61..80 run tp @s ^0 ^0.005 ^-0.005
execute if score @s AsaMatrix matches 81.. run function asa_animator:reus/normal/stay/end
