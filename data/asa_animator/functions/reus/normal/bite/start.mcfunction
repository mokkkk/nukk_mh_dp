execute as @e[type=armor_stand,tag=ReusParts,tag=HeadU] run data merge entity @s {Pose:{Head:[25f,0f,0f]}}
execute as @e[type=armor_stand,tag=ReusParts,tag=HeadL] run data merge entity @s {Pose:{Head:[27f,0f,0f]}}
